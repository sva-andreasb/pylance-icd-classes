def ():
    '''returns MethodGen\n\n
    (final int access_flags, final Type return_type, final Type[] arg_types, final String[] arg_names, final String method_name, final String class_name, final InstructionList il, final ConstantPool cp)\n
    (final Method m, final String class_name, final ConstantPool cp)\n
    (final Method m, final String class_name, final ConstantPool cp, final boolean useTags)\n
    '''
...
def getLocalVariableTable():
    ...
    getLocalVariableTable(final ConstantPool cp)\n
    '''
def addLineNumber():
...
def getLineNumberTable():
    ...
    getLineNumberTable(final ConstantPool cp)\n
    '''
...
def addParameterAnnotationsAsAttribute():
    '''returns None\n\n
    addParameterAnnotationsAsAttribute(final ConstantPool cp)\n
    '''
...
def addParameterAnnotation():
    '''returns None\n\n
    addParameterAnnotation(final int parameterIndex, final AnnotationGen annotation)\n
    '''
def push():
    '''returns None\n\n
