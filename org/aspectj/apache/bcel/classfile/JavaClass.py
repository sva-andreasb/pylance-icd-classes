def ():
    '''returns JavaClass\n\n
    (final int classnameIndex, final int superclassnameIndex, final String filename, final int major, final int minor, final int access_flags, final ConstantPool cpool, int[] interfaces, final Field[] fields, final Method[] methods, final Attribute[] attributes)\n
    '''
def accept():
    '''returns None\n\n
...
def getMethod():
    ...
    getMethod(final Constructor<?> c)\n
    '''
def getField():
    '''returns Field\n\n
    getField(final java.lang.reflect.Field field)\n
    '''
def getMinor():
    '''returns int\n\n
    getMinor()\n
