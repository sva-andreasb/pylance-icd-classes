def ():
    '''returns ReflectionShadow\n\n
    (final World world, final Kind kind, final org.aspectj.weaver.Member signature, final Shadow enclosingShadow, final ResolvedType enclosingType, final ResolvedMember enclosingMember, final MatchingContext withContext)\n
    '''
def getIWorld():
    '''returns World\n\n
    getIWorld()\n
...
def getThisJoinPointVar():
    ...
    getThisJoinPointVar()\n
    '''
def getThisJoinPointStaticPartVar():
    '''returns Var\n\n
    getThisJoinPointStaticPartVar()\n
    '''
def getThisEnclosingJoinPointStaticPartVar():
    '''returns Var\n\n
...
def getSourceLocation():
    ...
    getSourceLocation()\n
    '''
def getMatchingContext():
    '''returns MatchingContext\n\n
    getMatchingContext()\n
    '''
