def ():
    '''returns ThisOrTargetAnnotationPointcut\n\n
    (final boolean isThis, final ExactAnnotationTypePattern type)\n
    (final boolean isThis, final ExactAnnotationTypePattern type, final ShadowMunger munger)\n
    '''
