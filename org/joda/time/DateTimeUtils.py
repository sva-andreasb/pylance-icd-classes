...
def setCurrentMillisSystem():
    ...
    '''
def setCurrentMillisFixed():
    '''public static final void setCurrentMillisFixed(final long n)
    '''
def setCurrentMillisOffset():
    '''public static final void setCurrentMillisOffset(final long n)
    '''
def setCurrentMillisProvider():
    '''public static final void setCurrentMillisProvider(final MillisProvider cMillisProvider)
    '''
def getInstantMillis():
    '''public static final long getInstantMillis(final ReadableInstant readableInstant)
    '''
def getInstantChronology():
    '''public static final Chronology getInstantChronology(final ReadableInstant readableInstant)
    '''
def getIntervalChronology():
