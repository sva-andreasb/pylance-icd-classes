...
def get():
    ...
    get(final String entityName, final Serializable id)\n
    get(final String entityName, final Serializable id, final LockMode lockMode)\n
    '''
def doInHibernate():
    '''returns Object\n\n
...
def load():
    ...
    load(final String entityName, final Serializable id)\n
    load(final String entityName, final Serializable id, final LockMode lockMode)\n
...
def lock():
    ...
    lock(final String entityName, final Object entity, final LockMode lockMode)\n
    '''
def save():
    '''returns None\n\n
    save(final Object entity)\n
    save(final Object entity, final Serializable id)\n
    save(final String entityName, final Object entity)\n
    save(final String entityName, final Object entity, final Serializable id)\n
    '''
def update():
    '''returns None\n\n
    update(final Object entity)\n
    update(final Object entity, final LockMode lockMode)\n
    update(final String entityName, final Object entity)\n
    update(final String entityName, final Object entity, final LockMode lockMode)\n
    '''
def saveOrUpdate():
    '''returns None\n\n
    saveOrUpdate(final Object entity)\n
    saveOrUpdate(final String entityName, final Object entity)\n
    '''
def saveOrUpdateAll():
    '''returns None\n\n
...
def persist():
    '''returns None\n\n
    persist(final Object entity)\n
    persist(final String entityName, final Object entity)\n
    '''
def merge():
    '''returns Object\n\n
    merge(final Object entity)\n
    merge(final String entityName, final Object entity)\n
    '''
def delete():
    '''returns None\n\n
