...
def parse():
    ...
    public static XmlID parse(final URL u)
    public static XmlID parse(final URL u, final XmlOptions options)
    public static XmlID parse(final InputStream is)
    public static XmlID parse(final InputStream is, final XmlOptions options)
    public static XmlID parse(final Reader r)
    public static XmlID parse(final Reader r, final XmlOptions options)
    public static XmlID parse(final Node node)
    public static XmlID parse(final Node node, final XmlOptions options)
    public static XmlID parse(final XMLInputStream xis)
    public static XmlID parse(final XMLInputStream xis, final XmlOptions options)
    public static XmlID parse(final XMLStreamReader xsr)
