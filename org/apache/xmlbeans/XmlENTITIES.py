...
def parse():
    ...
    public static XmlENTITIES parse(final URL u)
    public static XmlENTITIES parse(final URL u, final XmlOptions options)
    public static XmlENTITIES parse(final InputStream is)
    public static XmlENTITIES parse(final InputStream is, final XmlOptions options)
    public static XmlENTITIES parse(final Reader r)
    public static XmlENTITIES parse(final Reader r, final XmlOptions options)
    public static XmlENTITIES parse(final Node node)
    public static XmlENTITIES parse(final Node node, final XmlOptions options)
    public static XmlENTITIES parse(final XMLInputStream xis)
    public static XmlENTITIES parse(final XMLInputStream xis, final XmlOptions options)
    public static XmlENTITIES parse(final XMLStreamReader xsr)
