...
def parse():
    ...
    public static XmlTime parse(final URL u)
    public static XmlTime parse(final URL u, final XmlOptions options)
    public static XmlTime parse(final InputStream is)
    public static XmlTime parse(final InputStream is, final XmlOptions options)
    public static XmlTime parse(final Reader r)
    public static XmlTime parse(final Reader r, final XmlOptions options)
    public static XmlTime parse(final Node node)
    public static XmlTime parse(final Node node, final XmlOptions options)
    public static XmlTime parse(final XMLInputStream xis)
    public static XmlTime parse(final XMLInputStream xis, final XmlOptions options)
    public static XmlTime parse(final XMLStreamReader xsr)
