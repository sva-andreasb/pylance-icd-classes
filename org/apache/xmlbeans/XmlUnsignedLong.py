...
def parse():
    ...
    public static XmlUnsignedLong parse(final URL u)
    public static XmlUnsignedLong parse(final URL u, final XmlOptions options)
    public static XmlUnsignedLong parse(final InputStream is)
    public static XmlUnsignedLong parse(final InputStream is, final XmlOptions options)
    public static XmlUnsignedLong parse(final Reader r)
    public static XmlUnsignedLong parse(final Reader r, final XmlOptions options)
    public static XmlUnsignedLong parse(final Node node)
    public static XmlUnsignedLong parse(final Node node, final XmlOptions options)
    public static XmlUnsignedLong parse(final XMLInputStream xis)
    public static XmlUnsignedLong parse(final XMLInputStream xis, final XmlOptions options)
    public static XmlUnsignedLong parse(final XMLStreamReader xsr)
