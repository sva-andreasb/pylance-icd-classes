...
public static XmlGDay parse(final URL u)
public static XmlGDay parse(final URL u, final XmlOptions options)
public static XmlGDay parse(final InputStream is)
public static XmlGDay parse(final InputStream is, final XmlOptions options)
public static XmlGDay parse(final Reader r)
public static XmlGDay parse(final Reader r, final XmlOptions options)
public static XmlGDay parse(final Node node)
public static XmlGDay parse(final Node node, final XmlOptions options)
public static XmlGDay parse(final XMLInputStream xis)
public static XmlGDay parse(final XMLInputStream xis, final XmlOptions options)
public static XmlGDay parse(final XMLStreamReader xsr)
