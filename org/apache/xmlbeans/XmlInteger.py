...
public static XmlInteger parse(final URL u)
public static XmlInteger parse(final URL u, final XmlOptions options)
public static XmlInteger parse(final InputStream is)
public static XmlInteger parse(final InputStream is, final XmlOptions options)
public static XmlInteger parse(final Reader r)
public static XmlInteger parse(final Reader r, final XmlOptions options)
public static XmlInteger parse(final Node node)
public static XmlInteger parse(final Node node, final XmlOptions options)
public static XmlInteger parse(final XMLInputStream xis)
public static XmlInteger parse(final XMLInputStream xis, final XmlOptions options)
public static XmlInteger parse(final XMLStreamReader xsr)
