...
def parse():
    ...
    public static XmlObject parse(final URL u)
    public static XmlObject parse(final URL u, final XmlOptions options)
    public static XmlObject parse(final InputStream is)
    public static XmlObject parse(final XMLStreamReader xsr)
    public static XmlObject parse(final InputStream is, final XmlOptions options)
    public static XmlObject parse(final XMLStreamReader xsr, final XmlOptions options)
    public static XmlObject parse(final Reader r)
    public static XmlObject parse(final Reader r, final XmlOptions options)
    public static XmlObject parse(final Node node)
    public static XmlObject parse(final Node node, final XmlOptions options)
    public static XmlObject parse(final XMLInputStream xis)
