...
def parse():
    ...
    public static XmlBase64Binary parse(final URL u)
    public static XmlBase64Binary parse(final URL u, final XmlOptions options)
    public static XmlBase64Binary parse(final InputStream is)
    public static XmlBase64Binary parse(final InputStream is, final XmlOptions options)
    public static XmlBase64Binary parse(final Reader r)
    public static XmlBase64Binary parse(final Reader r, final XmlOptions options)
    public static XmlBase64Binary parse(final Node node)
    public static XmlBase64Binary parse(final Node node, final XmlOptions options)
    public static XmlBase64Binary parse(final XMLInputStream xis)
    public static XmlBase64Binary parse(final XMLInputStream xis, final XmlOptions options)
    public static XmlBase64Binary parse(final XMLStreamReader xsr)
