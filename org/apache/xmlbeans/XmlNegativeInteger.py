...
def parse():
    ...
    public static XmlNegativeInteger parse(final URL u)
    public static XmlNegativeInteger parse(final URL u, final XmlOptions options)
    public static XmlNegativeInteger parse(final InputStream is)
    public static XmlNegativeInteger parse(final InputStream is, final XmlOptions options)
    public static XmlNegativeInteger parse(final Reader r)
    public static XmlNegativeInteger parse(final Reader r, final XmlOptions options)
    public static XmlNegativeInteger parse(final Node node)
    public static XmlNegativeInteger parse(final Node node, final XmlOptions options)
    public static XmlNegativeInteger parse(final XMLInputStream xis)
    public static XmlNegativeInteger parse(final XMLInputStream xis, final XmlOptions options)
    public static XmlNegativeInteger parse(final XMLStreamReader xsr)
