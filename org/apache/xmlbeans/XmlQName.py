...
public static XmlQName parse(final URL u)
public static XmlQName parse(final URL u, final XmlOptions options)
public static XmlQName parse(final InputStream is)
public static XmlQName parse(final InputStream is, final XmlOptions options)
public static XmlQName parse(final Reader r)
public static XmlQName parse(final Reader r, final XmlOptions options)
public static XmlQName parse(final Node node)
public static XmlQName parse(final Node node, final XmlOptions options)
public static XmlQName parse(final XMLInputStream xis)
public static XmlQName parse(final XMLInputStream xis, final XmlOptions options)
public static XmlQName parse(final XMLStreamReader xsr)
