...
public static XmlIDREFS parse(final URL u)
public static XmlIDREFS parse(final URL u, final XmlOptions options)
public static XmlIDREFS parse(final InputStream is)
public static XmlIDREFS parse(final InputStream is, final XmlOptions options)
public static XmlIDREFS parse(final Reader r)
public static XmlIDREFS parse(final Reader r, final XmlOptions options)
public static XmlIDREFS parse(final Node node)
public static XmlIDREFS parse(final Node node, final XmlOptions options)
public static XmlIDREFS parse(final XMLInputStream xis)
public static XmlIDREFS parse(final XMLInputStream xis, final XmlOptions options)
public static XmlIDREFS parse(final XMLStreamReader xsr)
