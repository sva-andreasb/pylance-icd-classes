...
def startPrefixMapping():
    '''returns None\n\n
    startPrefixMapping(final String s, final String s2, final Augmentations augmentations)\n
    '''
def startElement():
    '''returns None\n\n
...
def endPrefixMapping():
    '''returns None\n\n
    endPrefixMapping(final String s, final Augmentations augmentations)\n
    '''
def startCDATA():
    '''returns None\n\n
...
def setDTDContentModelSource():
    '''returns None\n\n
    setDTDContentModelSource(final XMLDTDContentModelSource fcmSource)\n
    '''
