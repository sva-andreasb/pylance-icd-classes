def ():
    '''returns ElementPSVImpl\n\n
    ()\n
    (final boolean fIsConstant, final ElementPSVI elementPSVI)\n
    '''
def constant():
    '''returns ItemPSVI\n\n
    constant()\n
...
def reset():
    ...
    reset()\n
    '''
def copySchemaInformationTo():
    '''returns None\n\n
    copySchemaInformationTo(final ElementPSVImpl elementPSVImpl)\n
    '''
