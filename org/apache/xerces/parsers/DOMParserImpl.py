def ():
    '''returns DOMParserImpl\n\n
    (final String s, final String s2)\n
    (final XMLParserConfiguration xmlParserConfiguration)\n
...
def getDomConfig():
    ...
    '''
def getFilter():
    '''returns LSParserFilter\n\n
    getFilter()\n
    '''
def setFilter():
    '''returns None\n\n
    setFilter(final LSParserFilter fdomFilter)\n
    '''
def setParameter():
    '''returns None\n\n
...
def parseURI():
    '''returns Document\n\n
    parseURI(final String s)\n
    '''
def parse():
    '''returns Document\n\n
    parse(final LSInput lsInput)\n
    '''
def parseWithContext():
    '''returns Node\n\n
    parseWithContext(final LSInput lsInput, final Node node, final short n)\n
    '''
def getAsync():
    '''returns boolean\n\n
    getAsync()\n
...
def startElement():
    ...
    startElement(final QName qName, final XMLAttributes xmlAttributes, final Augmentations augmentations)\n
    startElement(final Element element)\n
    '''
def startDocument():
    '''returns None\n\n
...
def setDocumentSource():
    '''returns None\n\n
    setDocumentSource(final XMLDocumentSource documentSource)\n
    '''
...
def setDTDSource():
    '''returns None\n\n
    setDTDSource(final XMLDTDSource dtdSource)\n
    '''
def getDTDSource():
...
def setDTDContentModelSource():
    '''returns None\n\n
    setDTDContentModelSource(final XMLDTDContentModelSource dtdContentSource)\n
    '''
