def getChildByTagOrFail():
    '''public static Element getChildByTagOrFail(final Element e, final String name)
    '''
def getFirstChildOrFail():
    '''public static Element getFirstChildOrFail(final Element e)
    '''
def getAttributeOrFail():
    '''public static String getAttributeOrFail(final Element e, final String name)
    '''
def getAttributeWithInheritanceOrFail():
    '''public static String getAttributeWithInheritanceOrFail(final Element e, final String name)
    '''
def getNonBlankTextOrFail():
    '''public static String getNonBlankTextOrFail(final Element e)
    '''
def getChildByTagName():
    '''public static Element getChildByTagName(final Element e, final String name)
    '''
def getAttributeWithInheritance():
    '''public static String getAttributeWithInheritance(final Element element, final String attributeName)
    '''
def getChildTextByTagName():
