IGNORE_TCCL_PROPERTY = "String  \"log4j.ignoreTCL\""
def getThreadContextClassLoader():
    '''public static ClassLoader getThreadContextClassLoader()
    '''
def getClassLoaders():
    '''public static ClassLoader[] getClassLoaders()
    '''
def isClassAvailable():
