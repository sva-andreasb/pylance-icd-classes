...
def needInputStream():
    ...
    '''
def needImageInputStream():
    '''public static ImageInputStream needImageInputStream(final Source src)
    '''
def hasInputStream():
    '''public static boolean hasInputStream(final Source src)
    '''
def hasReader():
    '''public static boolean hasReader(final Source src)
    '''
def hasImageInputStream():
