def ():
    '''returns DummyGraphics2d\n\n
    ()\n
    (final PrintStream log)\n
    (final PrintStream log, final Graphics2D g2D)\n
    '''
...
def hit():
    '''returns boolean\n\n
    hit(final Rectangle rect, final Shape s, final boolean onStroke)\n
    '''
def rotate():
    '''returns None\n\n
...
def create():
    '''returns Graphics\n\n
    create()\n
    create(final int x, final int y, final int width, final int height)\n
    '''
def dispose():
    '''returns None\n\n
    dispose()\n
...
def draw3DRect():
    '''returns None\n\n
    draw3DRect(final int x, final int y, final int width, final int height, final boolean raised)\n
    '''
def drawArc():
    '''returns None\n\n
...
def drawBytes():
    '''returns None\n\n
    drawBytes(final byte[] data, final int offset, final int length, final int x, final int y)\n
    '''
def drawChars():
    '''returns None\n\n
    drawChars(final char[] data, final int offset, final int length, final int x, final int y)\n
    '''
def drawLine():
    '''returns None\n\n
...
def fill3DRect():
    '''returns None\n\n
    fill3DRect(final int x, final int y, final int width, final int height, final boolean raised)\n
    '''
def fillArc():
    '''returns None\n\n
...
def getClipBounds():
    '''returns Rectangle\n\n
    getClipBounds()\n
    getClipBounds(final Rectangle r)\n
    '''
def getColor():
    '''returns Color\n\n
    getColor()\n
...
def hitClip():
    '''returns boolean\n\n
    hitClip(final int x, final int y, final int width, final int height)\n
    '''
def setClip():
    '''returns None\n\n
