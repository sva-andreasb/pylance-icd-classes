...
def writeDataHandler():
    '''public void writeDataHandler(final DataHandler dataHandler, String contentID, final boolean optimize)
    public void writeDataHandler(final DataHandlerProvider dataHandlerProvider, String contentID, final boolean optimize)
    '''
def close():
    '''public void close()
    '''
