...
def importOMElement():
    ...
    '''
def toSOAPHeaderBlock():
    '''public static SOAPHeaderBlock toSOAPHeaderBlock(final OMElement omElement, final SOAPFactory factory)
    '''
def getTextAsStream():
    '''public static Reader getTextAsStream(final OMElement element, final boolean cache)
    '''
def writeTextTo():
    '''public static void writeTextTo(final OMElement element, final Writer out, final boolean cache)
    '''
