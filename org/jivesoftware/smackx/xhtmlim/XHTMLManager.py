def getBodies():
    '''    public static List<CharSequence> getBodies(final Message message)
    '''
def addBody():
    '''    public static void addBody(final Message message, final XHTMLText xhtmlText)
    '''
def isXHTMLMessage():
    '''    public static boolean isXHTMLMessage(final Message message)
    '''
