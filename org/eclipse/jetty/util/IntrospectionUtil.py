def isJavaBeanCompliantSetter():
    '''    public static boolean isJavaBeanCompliantSetter(final Method method)
    '''
def findMethod():
    '''    public static Method findMethod(final Class<?> clazz, final String methodName, final Class<?>[] args, final boolean checkInheritance, final boolean strictArgs)
    '''
def findField():
    '''    public static Field findField(final Class<?> clazz, final String targetName, final Class<?> targetType, final boolean checkInheritance, final boolean strictType)
    '''
def isInheritable():
