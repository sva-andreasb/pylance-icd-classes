...
def valueOf():
    ...
    '''
def parseInt():
    '''public static int parseInt(final String s, final int offset, int length, final int base)
    public static int parseInt(final byte[] b, final int offset, int length, final int base)
    '''
def parseBytes():
...
def dump():
    ...
    '''
def readLine():
    '''public static byte[] readLine(final InputStream in)
    '''
def jarFor():
    '''public static URL jarFor(String className)
    '''
def call():
    '''public static Object call(final Class<?> oClass, final String method, final Object obj, final Object[] arg)
    '''
