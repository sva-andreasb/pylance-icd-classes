def getSize():
    '''returns long\n\n
    getSize(final Object object, final Class<?> type, final Type genericType, final Annotation[] annotation, final MediaType mediaType)\n
    '''
def isWriteable():
    '''returns boolean\n\n
...
def writeTo():
    '''returns None\n\n
    writeTo(final Object object, final Class<?> type, final Type genericType, final Annotation[] annotations, final MediaType mediaType, final MultivaluedMap<String, Object> map, final OutputStream outputStream)\n
    '''
def isReadable():
    '''returns boolean\n\n
