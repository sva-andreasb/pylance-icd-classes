def getDefaultValue():
    ...
    getDefaultValue()\n
    '''
def setInstanceClassGen():
    '''returns None\n\n
    setInstanceClassGen(final Class instanceClass)\n
    '''
def setGeneratedInstanceClass():
    '''returns None\n\n
    setGeneratedInstanceClass(final boolean isGenerated)\n
    '''
def isSerializable():
    '''returns boolean\n\n
    isSerializable()\n
...
def setSerializable():
    '''returns None\n\n
    setSerializable(final boolean newSerializable)\n
    '''
def eInverseAdd():
