...
def ():
    ...
    (final InternalEObject owner)\n
    (final InternalEObject owner, final EStructuralFeature eStructuralFeature, final List underlyingList)\n
    (final int kind, final InternalEObject owner)\n
