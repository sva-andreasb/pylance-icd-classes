def XmppXmlSplitter():
    ...
    public XmppXmlSplitter(final XmlPrinter xmlPrinter)
    public XmppXmlSplitter(final int maxElementSize, final XmppElementCallback xmppElementCallback, final XmlPrinter xmlPrinter)
    public XmppXmlSplitter(final int maxElementSize, final XmppElementCallback xmppElementCallback, final DeclarationCallback declarationCallback, final ProcessingInstructionCallback processingInstructionCallback, final XmlPrinter xmlPrinter)
    '''
