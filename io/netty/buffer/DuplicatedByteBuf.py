...
def slice():
    '''returns ByteBuf\n\n
    slice(final int index, final int length)\n
    '''
def getBytes():
    '''returns int\n\n
...
def forEachByte():
    '''returns int\n\n
    forEachByte(final int index, final int length, final ByteProcessor processor)\n
    '''
def forEachByteDesc():
    '''returns int\n\n
    forEachByteDesc(final int index, final int length, final ByteProcessor processor)\n
    '''
