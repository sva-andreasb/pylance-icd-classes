...
def createComponent():
    ...
    public VTimeZone createComponent(final PropertyList properties)
    public VTimeZone createComponent(final PropertyList properties, final ComponentList subComponents)
    '''
