def ():
    '''returns VJournalUserAgent\n\n
    (final ProdId prodId, final Organizer organizer, final UidGenerator uidGenerator)\n
    '''
def publish():
    '''returns Calendar\n\n
    publish(final VJournal... component)\n
    '''
def request():
    '''returns Calendar\n\n
    request(final VJournal... component)\n
    '''
def delegate():
    '''returns Calendar\n\n
...
def add():
    '''returns Calendar\n\n
    add(final VJournal component)\n
    '''
def cancel():
    '''returns Calendar\n\n
    cancel(final VJournal... component)\n
    '''
def refresh():
    '''returns Calendar\n\n
    refresh(final VJournal component)\n
    '''
def counter():
    '''returns Calendar\n\n
