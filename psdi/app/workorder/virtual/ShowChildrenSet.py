def ShowChildrenSet():
    '''    public ShowChildrenSet(final MboRemote owner)
    '''
def fetchMbos():
...
def canAdd():
    ...
    '''
def addAtEnd():
    '''    public MboRemote addAtEnd(final String jpWOClassSyn)
    '''
def addAtIndex():
    '''    public MboRemote addAtIndex(final long accessModifier, final String newChildClass, final int index)
