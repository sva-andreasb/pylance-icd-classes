def OSMboListener():
    '''    public OSMboListener(final String objectName, final String osName, final String subscriptionId, final String objectPath, final List<String> relationPath, final OSListener osListener, final boolean enforceOSRelation)
    '''
def eventAction():
