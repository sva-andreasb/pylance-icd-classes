def BidiAttributes():
    ...
    public BidiAttributes(final TextType type, final TextOrientation orientation, final TextSymSwapping swapping, final TextShaping shaping, final NumeralsShaping numerals)
    public BidiAttributes(final TextType type, final TextOrientation orientation, final TextShaping shaping, final NumeralsShaping numerals)
