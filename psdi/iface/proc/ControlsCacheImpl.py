...
def getXREFControl():
    ...
    getXREFControl(final String extsys, final String name, final String orgid, final String siteid, String currentValue, final boolean fromMaximo)\n
    '''
...
def doesXREFExist():
    '''returns boolean\n\n
    doesXREFExist(final String extsys, final String name, final String orgid, final String siteid, String currentValue, final boolean fromMaximo)\n
    '''
def getListControl():
