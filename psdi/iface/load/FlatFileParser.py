def FlatFileParser():
    ...
    public FlatFileParser(final File file, final String delim, final char textQualifier, final int startPosition, final boolean useHeader)
    public FlatFileParser(final BufferedReader reader, final String mosName, final String action, final String langCode, final String delim, final char textQualifier, final int startPosition)
    '''
