...
def getLineColor():
    ...
    '''
def getDeletedBackground():
    '''public Color getDeletedBackground()
    '''
def setDeletedBackground():
    '''public void setDeletedBackground(final Color deletedColor)
    '''
def setLineColor():
...
def getErrorIcon():
    ...
    '''
def setErrorIcon():
    '''public void setErrorIcon(final Icon errorIcon)
    '''
def scale():
