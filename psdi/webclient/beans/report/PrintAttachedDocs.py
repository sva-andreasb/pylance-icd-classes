def ():
    '''returns PrintAttachedDocs\n\n
    (final SessionContext sessionContext, final String appName, final MboRemote curMbo)\n
    '''
...
def initalize():
    '''returns None\n\n
    initalize(final String appName, final MboRemote curMbo)\n
    '''
