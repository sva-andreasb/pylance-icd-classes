def DMMapTreeSet():
    '''    public DMMapTreeSet(final MboServerInterface ms)
    '''
def addNode():
    '''    public MboRemote addNode(final long uniqueId, final String nodeDesc, final String relationship, final String cfgObject, final String mboObject, final MboRemote relatedMBO)
    '''
...
def getRelatedMbo():
    ...
    '''
def getNodeMap():
    '''    public DMMapTreeSequence getNodeMap()
    '''
def findMbo():
    '''    public MboRemote findMbo(final String key)
    '''
def setWhereForFilter():
    '''    public void setWhereForFilter(final String filter)
    '''
