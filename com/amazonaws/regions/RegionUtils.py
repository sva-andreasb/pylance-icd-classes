...
def getRegionsForService():
    '''public static List<Region> getRegionsForService(final String serviceAbbreviation)
    '''
def getRegion():
    '''public static Region getRegion(final String regionName)
    '''
def loadMetadataFromURI():
