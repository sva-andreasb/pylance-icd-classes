...
def ():
    ...
    (final AWSCredentialsProvider credentialsProvider, final ClientConfiguration clientConfiguration, final RequestMetricCollector requestMetricCollector)\n
...
def listVersions():
    ...
    listVersions(final String bucketName, final String prefix, final String keyMarker, final String versionIdMarker, final String delimiter, final Integer maxKeys)\n
...
def setObjectAcl():
    ...
    setObjectAcl(final String bucketName, final String key, final String versionId, final AccessControlList acl, final RequestMetricCollector requestMetricCollector)\n
    setObjectAcl(final String bucketName, final String key, final String versionId, final CannedAccessControlList acl)\n
    setObjectAcl(final String bucketName, final String key, final String versionId, final CannedAccessControlList acl, final RequestMetricCollector requestMetricCollector)\n
...
def setBucketAcl():
    ...
    setBucketAcl(final String bucketName, final AccessControlList acl, final RequestMetricCollector requestMetricCollector)\n
    setBucketAcl(final String bucketName, final CannedAccessControlList cannedAcl)\n
    setBucketAcl(final String bucketName, final CannedAccessControlList cannedAcl, final RequestMetricCollector requestMetricCollector)\n
...
def generatePresignedUrl():
    ...
    generatePresignedUrl(final GeneratePresignedUrlRequest req)\n
    '''
def abortMultipartUpload():
    '''returns None\n\n
    abortMultipartUpload(final AbortMultipartUploadRequest abortMultipartUploadRequest)\n
    '''
def completeMultipartUpload():
    '''returns CompleteMultipartUploadResult\n\n
    completeMultipartUpload(final CompleteMultipartUploadRequest completeMultipartUploadRequest)\n
    '''
def initiateMultipartUpload():
    '''returns InitiateMultipartUploadResult\n\n
    initiateMultipartUpload(final InitiateMultipartUploadRequest initiateMultipartUploadRequest)\n
    '''
def listMultipartUploads():
    '''returns MultipartUploadListing\n\n
    listMultipartUploads(final ListMultipartUploadsRequest listMultipartUploadsRequest)\n
    '''
def listParts():
    '''returns PartListing\n\n
    listParts(final ListPartsRequest listPartsRequest)\n
    '''
def uploadPart():
...
def restoreObject():
    '''returns None\n\n
    restoreObject(final RestoreObjectRequest restoreObjectRequest)\n
    restoreObject(final String bucketName, final String key, final int expirationInDays)\n
    '''
def getResourceUrl():
    '''returns String\n\n
    getResourceUrl(final String bucketName, final String key)\n
    '''
def getUrl():
    '''returns URL\n\n
...
def deleteBucketReplicationConfiguration():
    ...
    deleteBucketReplicationConfiguration(final DeleteBucketReplicationConfigurationRequest deleteBucketReplicationConfigurationRequest)\n
    '''
