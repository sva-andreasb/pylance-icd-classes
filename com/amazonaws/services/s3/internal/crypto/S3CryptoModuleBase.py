def putObjectSecurely():
    '''    public PutObjectResult putObjectSecurely(final PutObjectRequest req)
    '''
def abortMultipartUploadSecurely():
    '''    public final void abortMultipartUploadSecurely(final AbortMultipartUploadRequest req)
    '''
def copyPartSecurely():
    '''    public final CopyPartResult copyPartSecurely(final CopyPartRequest copyPartRequest)
    '''
...
def putLocalObjectSecurely():
    '''    public final void putLocalObjectSecurely(final UploadObjectRequest reqIn, final String uploadId, final OutputStream os)
    '''
def getS3CryptoScheme():
    '''    public final S3CryptoScheme getS3CryptoScheme()
    '''
def putInstructionFileSecurely():
    '''    public final PutObjectResult putInstructionFileSecurely(final PutInstructionFileRequest req)
    '''
