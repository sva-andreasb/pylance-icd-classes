...
def configureGantt():
    ...
    '''
def getTooltip():
    '''    public static DynamicTooltip getTooltip(final AbstractTreeGridMiniAppBean bean, final IWeekGanttModel model, final String id, final Date date)
    '''
def resolve():
    ...
    public String resolve(final String in)
    '''
def getParentTooltip():
    '''    public static DynamicTooltip getParentTooltip(final AbstractTreeGridMiniAppBean bean, final IWeekGanttModel model, final DataRow parent, final Set<JSONObject> shifts)
    '''
