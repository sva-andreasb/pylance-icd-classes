...
def toStringProps():
    ...
    '''
def encodeFields():
    '''public static void encodeFields(final IMXActivity act, final String[] fields, final Schedule model, final ReplyBuilder builder, final TreeGridUtil.ITGSerializationHelper helper)
    '''
def isInterruptable():
    '''public static boolean isInterruptable(final Schedule model, final Activity mxa)
    public static boolean isInterruptable(final IMXGanttModel model, final IMXActivity mxa)
    '''
def getTGNWParts():
    '''public static String getTGNWParts(final Schedule model, final Activity mxa, final TreeGridUtil.ITGSerializationHelper helper)
...
def equals():
    ...
    '''
def findConstraintFor():
    '''public static Constraint findConstraintFor(final Activity from, final Activity to)
    '''
def addGanttZooms():
    '''public static void addGanttZooms(final JSONObject root, final ISKDUIInfo skdUIInfo, final UIOptions options, final Schedule schedule, final JSONObject Gantt)
    '''
def resolveSelectedActivitiesById():
    '''public static List<Activity> resolveSelectedActivitiesById(final Schedule model, final List<Object> arr)
    '''
def isHidden():
...
def isCompleted():
    ...
    '''
def buildInfoRow():
    '''public static void buildInfoRow(final UIBuilder data, final Schedule leftSchedule, final long rightModelId, final UIOptions options)
    '''
def getInfoRowText():
    '''public static String getInfoRowText(final Schedule leftSchedule, final long rightModelId, final UIOptions options)
    '''
def resolve():
