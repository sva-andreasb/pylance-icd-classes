def CompareResourceHoursModelTGEmitter():
    '''    public CompareResourceHoursModelTGEmitter(final StreamingDataBuilder out, final UserInfo userInfo, final UIOptions options)
    '''
def beginNode():
