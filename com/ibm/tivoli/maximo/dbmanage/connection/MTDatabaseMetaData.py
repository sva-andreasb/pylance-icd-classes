...
def getColumnPrivileges():
    '''returns ResultSet\n\n
    getColumnPrivileges(final String catalog, final String schema, final String table, final String columnNamePattern)\n
    '''
def getColumns():
    '''returns ResultSet\n\n
    getColumns(final String catalog, final String schemaPattern, final String tableNamePattern, final String columnNamePattern)\n
    '''
def getConnection():
    '''returns Connection\n\n
    getConnection()\n
...
def getCrossReference():
    '''returns ResultSet\n\n
    getCrossReference(final String parentCatalog, final String parentSchema, final String parentTable, final String foreignCatalog, final String foreignSchema, final String foreignTable)\n
    '''
...
def getExportedKeys():
    '''returns ResultSet\n\n
    getExportedKeys(final String catalog, final String schema, final String table)\n
    '''
...
def getIndexInfo():
    '''returns ResultSet\n\n
    getIndexInfo(final String catalog, final String schema, final String table, final boolean unique, final boolean approximate)\n
    '''
...
def getPrimaryKeys():
    '''returns ResultSet\n\n
    getPrimaryKeys(final String catalog, final String schema, final String table)\n
    '''
def getProcedureColumns():
    '''returns ResultSet\n\n
    getProcedureColumns(final String catalog, final String schemaPattern, final String procedureNamePattern, final String columnNamePattern)\n
    '''
...
def getProcedures():
    '''returns ResultSet\n\n
    getProcedures(final String catalog, final String schemaPattern, final String procedureNamePattern)\n
    '''
...
def getTablePrivileges():
    '''returns ResultSet\n\n
    getTablePrivileges(final String catalog, final String schemaPattern, final String tableNamePattern)\n
    '''
def getTableTypes():
    '''returns ResultSet\n\n
    getTableTypes()\n
...
def getTables():
    '''returns ResultSet\n\n
    getTables(final String catalog, final String schemaPattern, final String tableNamePattern, final String[] types)\n
    '''
