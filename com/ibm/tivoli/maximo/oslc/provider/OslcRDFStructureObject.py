def ():
    '''returns OslcRDFStructureObject\n\n
    ...
    (final Resource data, final String mosName, final String path, final String messageType, final UserInfo userInfo)\n
    (final Element data)\n
    ()\n
    '''
def getName():
...
def getChildrenData():
    '''returns List\n\n
    getChildrenData(final String childPath)\n
    getChildrenData()\n
    '''
def hasDetailData():
    '''returns boolean\n\n
