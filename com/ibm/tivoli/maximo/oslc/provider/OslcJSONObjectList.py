def ():
    '''returns OslcJSONObjectList\n\n
    ()\n
    (final JSONArray c, final String osName, final String objectPath, final String messageType, final UserInfo userInfo, final boolean leanJson)\n
    '''
def size():
    '''returns int\n\n
    size()\n
...
def toJSONCollection():
    ...
    toJSONCollection(final Collection c)\n
    '''
def getList():
    '''returns List\n\n
    getList()\n
