def ():
    '''returns OslcJSONStructureData\n\n
    (final JSONArtifact data, final String mosName, final String path, final UserInfo userInfo, final String messageType, final boolean leanJson)\n
    '''
def isBroken():
    '''returns boolean\n\n
    isBroken()\n
