def OslcJSONStructureData():
'''public OslcJSONStructureData(final JSONArtifact data, final String mosName, final String path, final UserInfo userInfo, final String messageType, final boolean leanJson)
'''
pass
def isBroken():
