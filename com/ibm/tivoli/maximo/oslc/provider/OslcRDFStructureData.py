def OslcRDFStructureData():
    '''public OslcRDFStructureData(final Resource data, final String mosName, final String path, final UserInfo userInfo, final String messageType)
    '''
def isBroken():
