def ():
    '''returns RefreshGWActivityDataManager\n\n
...
def reloadDataObjects():
    ...
    reloadDataObjects(final IMXGanttModel model, final MboRemote projectMbo, final String objectName, final List<IMXActivity> selectedActivities, final boolean selectedOnly)\n
    '''
