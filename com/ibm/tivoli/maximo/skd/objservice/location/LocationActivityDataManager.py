def LocationActivityDataManager():
    '''    public LocationActivityDataManager()
    '''
def populate():
...
def populateActivityPropertyDetails():
    ...
    '''
def populateActivityParentFromLocations():
    '''    public void populateActivityParentFromLocations(final String objectname, final String uniqueidname)
    '''
