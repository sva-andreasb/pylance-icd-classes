CACHEKEY_RESOURCETOOLDATA_LOADED = "String  \"RotatingToolResourceDataManager-ToolDataLoaded\""
CACHEKEY_RESOURCETOOLDATA = "String  \"RotatingToolResourceDataManager-ToolData\""
...
def resourceRecordCount():
    ...
    '''
def getToolResourceAvailableData():
    '''public void getToolResourceAvailableData(final String objectName, final String projectId)
    '''
