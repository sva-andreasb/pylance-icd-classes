def CustomSummaryRenderer():
    '''public CustomSummaryRenderer()
    public CustomSummaryRenderer(final boolean addComplianceBars)
    '''
...
def createSelection():
    ...
    '''
def CustomSummaryMainRenderer():
    '''public CustomSummaryMainRenderer()
    '''
def getPopupMenu():
