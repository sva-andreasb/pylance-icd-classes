def ScheduleCostView():
    '''public ScheduleCostView()
    '''
def handleMessage():
...
def getScheduleChart():
    ...
    '''
def getLoadChart():
    '''public SKDScheduleCostChart getLoadChart()
    '''
def isEditable():
...
def getDividerComponent():
    ...
    '''
def disableResourceSelectionListener():
    '''public void disableResourceSelectionListener()
    '''
def enableResourceSelectionListener():
    '''public void enableResourceSelectionListener()
    '''
