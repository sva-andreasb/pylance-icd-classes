def RefreshMXGanttModelHelper():
    '''public RefreshMXGanttModelHelper(final MXServer mxServer, final MaximoDD maximoDD, final SKDDD skdDD, final SKDAppService skdAppService)
    '''
def refreshModel():
