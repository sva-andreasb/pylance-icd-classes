...
def setImpactedASset():
    ...
    '''
def AssetNodeVisitor():
    '''public AssetNodeVisitor(final IlvDefaultSDMModel model, final int maxNodeDepth, final int maxAssetDepth, final int maxNodes, final TopologyControl topologyControl)
    '''
def nativeInit():
