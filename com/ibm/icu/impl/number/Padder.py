FALLBACK_PADDING_STRING = "String  \" \""
def Padder():
...
def isValid():
    ...
    '''
def padAndApply():
    '''public int padAndApply(final Modifier mod1, final Modifier mod2, final FormattedStringBuilder string, final int leftIndex, final int rightIndex)
    '''
def fromOld():
