def ControllerAgentImpl():
    '''public ControllerAgentImpl(final String s, final boolean b)
    '''
def close():
    '''public void close()
    '''
...
def registerMonitorDataSource():
    '''public void registerMonitorDataSource(final String s, final String s2, final String[] array, final int n, final String s3, final String[] array2, final int i, final int n2, final int j, final int k, final boolean b, final int[] array3, final String[] array4, final String s4, final int l, final int n3)
    '''
