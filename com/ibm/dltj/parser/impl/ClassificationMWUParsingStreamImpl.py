...
def ClassificationMWUParsingStreamImpl():
    '''public ClassificationMWUParsingStreamImpl(final UniLexAnalyzer uniLex, final ClassificationParsingStream cParsingStream)
    '''
def addToFork():
