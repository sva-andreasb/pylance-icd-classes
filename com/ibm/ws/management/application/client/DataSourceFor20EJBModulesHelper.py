...
def prepareTask():
    ...
    '''
def GetEJB2_0CmpBinding():
    '''returns None\n\n
    GetEJB2_0CmpBinding(final AppDeploymentInfo appInstallInfo, final EJBJarBinding ejbJarBinding, final EJBJar jar, final Vector data, final int appVersion, final String callerVersion)\n
    '''
def completeTask():
    '''returns None\n\n
