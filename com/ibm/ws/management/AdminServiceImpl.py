...
def getAttribute():
    '''returns Object\n\n
    getAttribute(ObjectName name, final String attribute)\n
    '''
def getAttributes():
    '''returns AttributeList\n\n
    getAttributes(ObjectName name, final String[] attributes)\n
    '''
def setAttribute():
    '''returns None\n\n
    setAttribute(ObjectName name, final Attribute attribute)\n
    '''
def setAttributes():
    '''returns AttributeList\n\n
    setAttributes(ObjectName name, final AttributeList attributes)\n
    '''
def invoke():
    '''returns Object\n\n
...
def isInstanceOf():
    '''returns boolean\n\n
    isInstanceOf(ObjectName name, final String className)\n
    '''
