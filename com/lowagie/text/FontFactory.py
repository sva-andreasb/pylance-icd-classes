...
def getFont():
'''public static Font getFont(String fontname, final String encoding, final boolean embedded, final float size, int style, final Color color)
...
'''
pass
def registerDirectories():
'''public static int registerDirectories()
'''
pass
def getRegisteredFonts():
'''public static Set getRegisteredFonts()
'''
pass
def getRegisteredFamilies():
