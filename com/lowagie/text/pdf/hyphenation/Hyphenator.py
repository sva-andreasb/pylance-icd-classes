def Hyphenator():
    ...
    '''
def getHyphenationTree():
    '''    public static HyphenationTree getHyphenationTree(final String lang, final String country)
    '''
def getFopHyphenationTree():
    '''    public static HyphenationTree getFopHyphenationTree(final String key)
    '''
def getUserHyphenationTree():
    '''    public static HyphenationTree getUserHyphenationTree(final String key, final String hyphenDir)
    '''
def hyphenate():
    ...
    '''
def setMinRemainCharCount():
    '''    public void setMinRemainCharCount(final int min)
    '''
def setMinPushCharCount():
