...
def addIterator():
    ...
    '''
def addReifications():
    '''    public static void addReifications(final Graph ours, final Graph g)
    '''
def deleteReifications():
    '''    public static void deleteReifications(final Graph ours, final Graph g)
    '''
def delete():
