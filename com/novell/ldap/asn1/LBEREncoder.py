def encode():
    ...
    public final void encode(final ASN1Structured asn1Structured, final OutputStream outputStream)
    public final void encode(final ASN1Tagged asn1Tagged, final OutputStream outputStream)
    public final void encode(final ASN1Identifier asn1Identifier, final OutputStream outputStream)
    '''
