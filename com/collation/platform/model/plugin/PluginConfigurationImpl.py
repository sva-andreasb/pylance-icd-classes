def PluginConfigurationImpl():
    '''    public PluginConfigurationImpl()
    public PluginConfigurationImpl(final Map m)
    '''
def getAnyOs():
    '''    public boolean getAnyOs()
    '''
def hasAnyOs():
    '''    public boolean hasAnyOs()
    '''
def setAnyOs():
    '''    public void setAnyOs(final boolean anyOs)
    '''
def getAnyOsPluginDef():
    '''    public PluginDefinition getAnyOsPluginDef()
    '''
def hasAnyOsPluginDef():
    '''    public boolean hasAnyOsPluginDef()
    '''
def setAnyOsPluginDef():
    '''    public void setAnyOsPluginDef(final PluginDefinition pluginDef)
    '''
def getPluginOsMaps():
    '''    public PluginOsMapping[] getPluginOsMaps()
    '''
def hasPluginOsMaps():
    '''    public boolean hasPluginOsMaps()
    '''
def setPluginOsMaps():
    '''    public void setPluginOsMaps(final PluginOsMapping[] pluginMaps)
    '''
def getGuid():
    '''    public Guid getGuid()
    '''
