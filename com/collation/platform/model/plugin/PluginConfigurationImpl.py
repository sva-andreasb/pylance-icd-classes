def ():
    '''returns PluginConfigurationImpl\n\n
    ()\n
    (final Map m)\n
    '''
def getAnyOs():
...
def setAnyOsPluginDef():
    '''returns None\n\n
    setAnyOsPluginDef(final PluginDefinition pluginDef)\n
    '''
def getPluginOsMaps():
    '''returns PluginOsMapping[]\n\n
    getPluginOsMaps()\n
    '''
def hasPluginOsMaps():
    '''returns boolean\n\n
...
def setPluginOsMaps():
    '''returns None\n\n
    setPluginOsMaps(final PluginOsMapping[] pluginMaps)\n
    '''
def getGuid():
    '''returns Guid\n\n
    getGuid()\n
