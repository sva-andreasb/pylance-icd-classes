def PluginOsMappingImpl():
    '''    public PluginOsMappingImpl()
    public PluginOsMappingImpl(final Map m)
    '''
def getPluginDef():
    '''    public PluginDefinition getPluginDef()
    '''
def hasPluginDef():
    '''    public boolean hasPluginDef()
    '''
def setPluginDef():
    '''    public void setPluginDef(final PluginDefinition pluginDef)
    '''
def getOsNameList():
    '''    public String getOsNameList()
    '''
def hasOsNameList():
    '''    public boolean hasOsNameList()
    '''
def setOsNameList():
    '''    public void setOsNameList(final String osNames)
    '''
def getGuid():
    '''    public Guid getGuid()
    '''
