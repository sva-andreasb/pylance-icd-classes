...
def setPluginType():
    '''returns None\n\n
    setPluginType(final String pluginType)\n
    '''
def getCommandName():
    '''returns String\n\n
    getCommandName()\n
...
def setLocalWorkingDirectory():
    '''returns None\n\n
    setLocalWorkingDirectory(final String localLocation)\n
    '''
...
def setCommandRemote():
    '''returns None\n\n
    setCommandRemote(final boolean runRemotely)\n
    '''
...
def setRemoteWorkingDirectory():
    '''returns None\n\n
    setRemoteWorkingDirectory(final String remoteLocation)\n
    '''
def getGuid():
    '''returns Guid\n\n
    getGuid()\n
