def ViewDefinitionImpl():
'''public ViewDefinitionImpl()
public ViewDefinitionImpl(final Map m)
'''
pass
def getName():
...
'''
pass
def getViewConstructs():
'''public ViewConstruct[] getViewConstructs()
'''
pass
def hasViewConstructs():
'''public boolean hasViewConstructs()
'''
pass
def setViewConstructs():
'''public void setViewConstructs(final ViewConstruct[] viewConstructs)
'''
pass
def getExcludeViewConstructs():
'''public ViewConstruct[] getExcludeViewConstructs()
'''
pass
def hasExcludeViewConstructs():
'''public boolean hasExcludeViewConstructs()
'''
pass
def setExcludeViewConstructs():
'''public void setExcludeViewConstructs(final ViewConstruct[] viewConstructs)
'''
pass
def getGuid():
'''public Guid getGuid()
