...
def setViewConstructs():
    '''returns None\n\n
    setViewConstructs(final ViewConstruct[] viewConstructs)\n
    '''
...
def setExcludeViewConstructs():
    '''returns None\n\n
    setExcludeViewConstructs(final ViewConstruct[] viewConstructs)\n
    '''
def getGuid():
    '''returns Guid\n\n
    getGuid()\n
