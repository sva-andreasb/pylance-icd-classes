...
def setContainedNodes():
    '''returns None\n\n
    setContainedNodes(final boolean b)\n
    '''
...
def setTypesOfClasses():
    '''returns None\n\n
    setTypesOfClasses(final String type)\n
    '''
...
def setDependencyLevels():
    '''returns None\n\n
    setDependencyLevels(final int dep)\n
    '''
def getObjectId():
    '''returns long\n\n
    getObjectId()\n
...
def setParent():
    '''returns None\n\n
    setParent(final UserPreference userPreference)\n
    '''
def toString():
    '''returns String\n\n
    toString()\n
