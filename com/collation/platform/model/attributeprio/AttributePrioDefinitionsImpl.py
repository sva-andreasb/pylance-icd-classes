def ():
    '''returns AttributePrioDefinitionsImpl\n\n
    ()\n
    (final Map m)\n
    '''
...
def setPrioClassName():
    '''returns None\n\n
    setPrioClassName(final String prioClassName)\n
    '''
...
def setPrioAttributeName():
    '''returns None\n\n
    setPrioAttributeName(final String prioAttributeName)\n
    '''
...
def setPriorityString():
    '''returns None\n\n
    setPriorityString(final String prioString)\n
    '''
def getGuid():
    '''returns Guid\n\n
    getGuid()\n
