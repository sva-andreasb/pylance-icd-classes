def AttributePrioDefinitionsImpl():
    '''    public AttributePrioDefinitionsImpl()
    public AttributePrioDefinitionsImpl(final Map m)
    '''
...
def setPrioClassName():
    '''    public void setPrioClassName(final String prioClassName)
    '''
...
def setPrioAttributeName():
    '''    public void setPrioAttributeName(final String prioAttributeName)
    '''
...
def setPriorityString():
    '''    public void setPriorityString(final String prioString)
    '''
def getGuid():
    '''    public Guid getGuid()
    '''
