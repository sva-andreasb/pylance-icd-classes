def ApplicationTemplateImpl():
    '''public ApplicationTemplateImpl()
    public ApplicationTemplateImpl(final Map m)
    '''
def getName():
...
def setName():
    ...
    '''
def getMemberSet():
    '''public TemplateGroup[] getMemberSet()
    '''
def hasMemberSet():
    '''public boolean hasMemberSet()
    '''
def setMemberSet():
    '''public void setMemberSet(final TemplateGroup[] set)
    '''
def getGuid():
    '''public Guid getGuid()
    '''
