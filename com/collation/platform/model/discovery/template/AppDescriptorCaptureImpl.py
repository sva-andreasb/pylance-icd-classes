def ():
    '''returns AppDescriptorCaptureImpl\n\n
    ()\n
    (final Map m)\n
    '''
def getParent():
...
def setParent():
    '''returns None\n\n
    setParent(final Template parent)\n
    '''
def getMaxSize():
    '''returns int\n\n
    getMaxSize()\n
...
def setStatOnly():
    '''returns None\n\n
    setStatOnly(final boolean statOnly)\n
    '''
def getPathPrefix():
    '''returns String\n\n
    getPathPrefix()\n
...
def setPathPrefix():
    '''returns None\n\n
    setPathPrefix(final String pathPrefix)\n
    '''
...
def setRecurseDirectory():
    '''returns None\n\n
    setRecurseDirectory(final boolean recurse)\n
    '''
def getGuid():
    '''returns Guid\n\n
    getGuid()\n
