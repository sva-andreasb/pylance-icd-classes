def ObjectRediscoveryInfoImpl():
    '''    public ObjectRediscoveryInfoImpl()
    public ObjectRediscoveryInfoImpl(final Map m)
    '''
def getObjGuid():
    '''    public Guid getObjGuid()
    '''
def hasObjGuid():
    '''    public boolean hasObjGuid()
    '''
def setObjGuid():
    '''    public void setObjGuid(final Guid objGuid)
    '''
def getObjGuids():
    '''    public ModelObject[] getObjGuids()
    '''
def hasObjGuids():
    '''    public boolean hasObjGuids()
    '''
def setObjGuids():
    '''    public void setObjGuids(final ModelObject[] objGuids)
    '''
def getAgentConfigurationGuid():
    '''    public Guid getAgentConfigurationGuid()
    '''
def hasAgentConfigurationGuid():
    '''    public boolean hasAgentConfigurationGuid()
    '''
def setAgentConfigurationGuid():
    '''    public void setAgentConfigurationGuid(final Guid acGuid)
    '''
def getAgentConfigurationName():
    '''    public String getAgentConfigurationName()
    '''
def hasAgentConfigurationName():
    '''    public boolean hasAgentConfigurationName()
    '''
def setAgentConfigurationName():
    '''    public void setAgentConfigurationName(final String acName)
    '''
def getSeed():
    '''    public byte[] getSeed()
    '''
