def ():
    '''returns ObjectRediscoveryInfoImpl\n\n
    ()\n
    (final Map m)\n
    '''
def getObjGuid():
...
def setObjGuids():
    '''returns None\n\n
    setObjGuids(final ModelObject[] objGuids)\n
    '''
...
def setAgentConfigurationGuid():
    '''returns None\n\n
    setAgentConfigurationGuid(final Guid acGuid)\n
    '''
...
def setAgentConfigurationName():
    '''returns None\n\n
    setAgentConfigurationName(final String acName)\n
    '''
def getSeed():
    '''returns byte[]\n\n
    getSeed()\n
