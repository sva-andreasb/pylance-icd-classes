...
def setAgentConfigurations():
    '''returns None\n\n
    setAgentConfigurations(final AgentConfiguration[] acs)\n
    '''
def getProperties():
    '''returns Property[]\n\n
    getProperties()\n
...
def setScopeRestrictions():
    '''returns None\n\n
    setScopeRestrictions(final ScopeRestriction[] scopeRestrictions)\n
    '''
def getAccessList():
    '''returns ProfileAccessEntry[]\n\n
    getAccessList()\n
    '''
def hasAccessList():
    '''returns boolean\n\n
...
def setAccessList():
    '''returns None\n\n
    setAccessList(final ProfileAccessEntry[] accessList)\n
    '''
