def CDMQueryImpl():
    '''public CDMQueryImpl()
    public CDMQueryImpl(final Map m)
    '''
def setName():
...
def hasQuery():
    ...
    '''
def setFilterScope():
    '''public void setFilterScope(final boolean filterScope)
    '''
def getFilterScope():
    '''public boolean getFilterScope()
    '''
def hasFilterScope():
    '''public boolean hasFilterScope()
    '''
def setUser():
...
def hasUser():
    ...
    '''
def setAttributes():
    '''public void setAttributes(final CDMAttribute[] attributes)
    '''
def getAttributes():
    '''public CDMAttribute[] getAttributes()
    '''
def hasAttributes():
