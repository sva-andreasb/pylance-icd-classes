def VeritasClusterMappingImpl():
    '''public VeritasClusterMappingImpl()
    public VeritasClusterMappingImpl(final Map m)
    '''
def getVeritasType():
    '''public String getVeritasType()
    '''
def hasVeritasType():
    '''public boolean hasVeritasType()
    '''
def setVeritasType():
    '''public void setVeritasType(final String veritasType)
    '''
def getModelClass():
...
def setModelClass():
    ...
    '''
def getAttrMappings():
    '''public VeritasClusterAttrMapping[] getAttrMappings()
    '''
def hasAttrMappings():
    '''public boolean hasAttrMappings()
    '''
def setAttrMappings():
    '''public void setAttrMappings(final VeritasClusterAttrMapping[] attrMappings)
    '''
def getGuid():
    '''public Guid getGuid()
    '''
