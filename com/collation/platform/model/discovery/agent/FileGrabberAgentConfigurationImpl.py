def FileGrabberAgentConfigurationImpl():
    '''public FileGrabberAgentConfigurationImpl()
    public FileGrabberAgentConfigurationImpl(final Map m)
    '''
def getFileName():
...
def setLocalFileName():
    ...
    '''
def getOptimizeLocal():
    '''public String getOptimizeLocal()
    '''
def hasOptimizeLocal():
    '''public boolean hasOptimizeLocal()
    '''
def setOptimizeLocal():
    '''public void setOptimizeLocal(final String optimize)
    '''
def getGuid():
    '''public Guid getGuid()
    '''
