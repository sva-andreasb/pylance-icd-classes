def CiscoWorksAgentConfigurationImpl():
    '''public CiscoWorksAgentConfigurationImpl()
    public CiscoWorksAgentConfigurationImpl(final Map m)
    '''
def getHttpTimeout():
...
def hasHttpTimeout():
    ...
    '''
def setHttpTimeout():
    '''public void setHttpTimeout(final int timeout)
    '''
def getGuid():
    '''public Guid getGuid()
    '''
