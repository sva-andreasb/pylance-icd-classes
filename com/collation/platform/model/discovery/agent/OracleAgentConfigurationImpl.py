def OracleAgentConfigurationImpl():
    '''public OracleAgentConfigurationImpl()
    public OracleAgentConfigurationImpl(final Map m)
    '''
def getExtendedSchemaDiscovery():
    '''public OracleMetadata getExtendedSchemaDiscovery()
    '''
def hasExtendedSchemaDiscovery():
    '''public boolean hasExtendedSchemaDiscovery()
    '''
def setExtendedSchemaDiscovery():
    '''public void setExtendedSchemaDiscovery(final OracleMetadata metadata)
    '''
def getGuid():
    '''public Guid getGuid()
    '''
