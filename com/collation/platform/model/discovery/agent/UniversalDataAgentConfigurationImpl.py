def ():
    '''returns UniversalDataAgentConfigurationImpl\n\n
    ()\n
    (final Map m)\n
    '''
def getMatchTag():
...
def setParserClassName():
    '''returns None\n\n
    setParserClassName(final String className)\n
    '''
...
def setParserParameters():
    '''returns None\n\n
    setParserParameters(final String params)\n
    '''
def getXSL():
    '''returns String\n\n
    getXSL()\n
...
def setXSLFileName():
    '''returns None\n\n
    setXSLFileName(final String filename)\n
    '''
...
def setLocalFileName():
    '''returns None\n\n
    setLocalFileName(final String filename)\n
    '''
...
def setFileDelimiter():
    '''returns None\n\n
    setFileDelimiter(final String delimiter)\n
    '''
def getGuid():
    '''returns Guid\n\n
    getGuid()\n
