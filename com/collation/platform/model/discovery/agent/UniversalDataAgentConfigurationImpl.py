def UniversalDataAgentConfigurationImpl():
    '''    public UniversalDataAgentConfigurationImpl()
    public UniversalDataAgentConfigurationImpl(final Map m)
    '''
def getMatchTag():
    '''    public String getMatchTag()
    '''
def hasMatchTag():
    '''    public boolean hasMatchTag()
    '''
def setMatchTag():
    '''    public void setMatchTag(final String tag)
    '''
def getParserClassName():
    '''    public String getParserClassName()
    '''
def hasParserClassName():
    '''    public boolean hasParserClassName()
    '''
def setParserClassName():
    '''    public void setParserClassName(final String className)
    '''
def getParserParameters():
    '''    public String getParserParameters()
    '''
def hasParserParameters():
    '''    public boolean hasParserParameters()
    '''
def setParserParameters():
    '''    public void setParserParameters(final String params)
    '''
def getXSL():
...
def hasXSLFileName():
    ...
    '''
def setXSLFileName():
    '''    public void setXSLFileName(final String filename)
    '''
def getLocalFileName():
    '''    public String getLocalFileName()
    '''
def hasLocalFileName():
    '''    public boolean hasLocalFileName()
    '''
def setLocalFileName():
    '''    public void setLocalFileName(final String filename)
    '''
def getFileDelimiter():
    '''    public String getFileDelimiter()
    '''
def hasFileDelimiter():
    '''    public boolean hasFileDelimiter()
    '''
def setFileDelimiter():
    '''    public void setFileDelimiter(final String delimiter)
    '''
def getGuid():
    '''    public Guid getGuid()
    '''
