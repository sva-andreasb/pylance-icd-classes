def DominoServerAgentConfigurationImpl():
    '''public DominoServerAgentConfigurationImpl()
    public DominoServerAgentConfigurationImpl(final Map m)
    '''
def setIIOPServers():
    '''public void setIIOPServers(final DominoIIOPServer[] s)
    '''
def getIIOPServers():
    '''public DominoIIOPServer[] getIIOPServers()
    '''
def hasIIOPServers():
    '''public boolean hasIIOPServers()
    '''
def getGuid():
    '''public Guid getGuid()
    '''
