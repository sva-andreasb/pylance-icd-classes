def ():
    '''returns PortScanAgentConfigurationImpl\n\n
    ()\n
    (final Map m)\n
    '''
def getPortList():
...
def setPortList():
    '''returns None\n\n
    setPortList(final String portList)\n
    '''
...
def setUseDefaultPortList():
    '''returns None\n\n
    setUseDefaultPortList(final boolean use)\n
    '''
def getTimeout():
    '''returns int\n\n
    getTimeout()\n
...
def setNumAttempts():
    '''returns None\n\n
    setNumAttempts(final int attempts)\n
    '''
def getGuid():
    '''returns Guid\n\n
    getGuid()\n
