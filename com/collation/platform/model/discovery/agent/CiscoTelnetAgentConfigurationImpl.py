def CiscoTelnetAgentConfigurationImpl():
'''public CiscoTelnetAgentConfigurationImpl()
public CiscoTelnetAgentConfigurationImpl(final Map m)
'''
pass
def getCheckTimeout():
...
pass
def hasCheckTimeout():
'''public boolean hasCheckTimeout()
'''
pass
def setCheckTimeout():
'''public void setCheckTimeout(final int timeout)
'''
pass
def getExpectTimeout():
'''public int getExpectTimeout()
'''
pass
def hasExpectTimeout():
'''public boolean hasExpectTimeout()
'''
pass
def setExpectTimeout():
'''public void setExpectTimeout(final int timeout)
'''
pass
def getCommands():
