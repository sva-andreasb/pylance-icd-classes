def OracleMetadataImpl():
    '''public OracleMetadataImpl()
    public OracleMetadataImpl(final Map m)
    '''
def getName():
...
def getSchemaObjects():
    '''public OracleSchemaProps[] getSchemaObjects()
    '''
def hasSchemaObjects():
    '''public boolean hasSchemaObjects()
    '''
def setSchemaObjects():
    '''public void setSchemaObjects(final OracleSchemaProps[] schemaObjects)
    '''
def getGuid():
    '''public Guid getGuid()
    '''
