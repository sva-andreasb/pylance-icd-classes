def StorageAgentConfigurationImpl():
'''public StorageAgentConfigurationImpl()
public StorageAgentConfigurationImpl(final Map m)
'''
pass
def getFdiskCommand():
'''public String getFdiskCommand()
'''
pass
def hasFdiskCommand():
'''public boolean hasFdiskCommand()
'''
pass
def setFdiskCommand():
'''public void setFdiskCommand(final String fileName)
'''
pass
def getActiveDisksOnly():
'''public boolean getActiveDisksOnly()
'''
pass
def hasActiveDisksOnly():
'''public boolean hasActiveDisksOnly()
'''
pass
def setActiveDisksOnly():
'''public void setActiveDisksOnly(final boolean activeDisksOnly)
'''
pass
def getGuid():
'''public Guid getGuid()
