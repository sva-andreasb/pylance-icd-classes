def ():
    '''returns SnmpAgentConfigurationImpl\n\n
    ()\n
    (final Map m)\n
    '''
def getSnmpPort():
...
def setSnmpTimeout():
    '''returns None\n\n
    setSnmpTimeout(final int timeout)\n
    '''
def getLocale():
    '''returns String\n\n
    getLocale()\n
...
def setCharacterEncoding():
    '''returns None\n\n
    setCharacterEncoding(final String characterEncoding)\n
    '''
...
def setScanL2Interfaces():
    '''returns None\n\n
    setScanL2Interfaces(final String val)\n
    '''
def getGuid():
    '''returns Guid\n\n
    getGuid()\n
