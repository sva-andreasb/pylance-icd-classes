def SnmpAgentConfigurationImpl():
    '''    public SnmpAgentConfigurationImpl()
    public SnmpAgentConfigurationImpl(final Map m)
    '''
def getSnmpPort():
    '''    public int getSnmpPort()
    '''
def hasSnmpPort():
    '''    public boolean hasSnmpPort()
    '''
def setSnmpPort():
    '''    public void setSnmpPort(final int port)
    '''
def getSnmpTimeout():
    '''    public int getSnmpTimeout()
    '''
def hasSnmpTimeout():
    '''    public boolean hasSnmpTimeout()
    '''
def setSnmpTimeout():
    '''    public void setSnmpTimeout(final int timeout)
    '''
def getLocale():
...
def getCharacterEncoding():
    ...
    '''
def hasCharacterEncoding():
    '''    public boolean hasCharacterEncoding()
    '''
def setCharacterEncoding():
    '''    public void setCharacterEncoding(final String characterEncoding)
    '''
def getScanL2Interfaces():
    '''    public String getScanL2Interfaces()
    '''
def hasScanL2Interfaces():
    '''    public boolean hasScanL2Interfaces()
    '''
def setScanL2Interfaces():
    '''    public void setScanL2Interfaces(final String val)
    '''
def getGuid():
    '''    public Guid getGuid()
    '''
