def ArtsAgentConfigurationImpl():
    '''    public ArtsAgentConfigurationImpl()
    public ArtsAgentConfigurationImpl(final Map m)
    '''
def getTimeDelay():
...
def hasTimeDelay():
    ...
    '''
def setTimeDelay():
    '''    public void setTimeDelay(final String timeDelay)
    '''
def getGuid():
    '''    public Guid getGuid()
    '''
