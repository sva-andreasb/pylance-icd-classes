def IpRangeScopeImpl():
    '''    public IpRangeScopeImpl()
    public IpRangeScopeImpl(final Map m)
    '''
def getStart():
...
def hasStart():
    ...
    '''
def setStart():
    '''    public void setStart(final String ip)
    '''
def getEnd():
...
def hasEnd():
    ...
    '''
def setEnd():
    '''    public void setEnd(final String ip)
    '''
...
def setRoles():
    ...
    '''
def getKeyGuid():
    '''    public Guid getKeyGuid()
    '''
def hasKeyGuid():
    '''    public boolean hasKeyGuid()
    '''
def setKeyGuid():
    '''    public void setKeyGuid(final Guid keyId)
    '''
def getName():
...
def setName():
    ...
    '''
def getExcludes():
    '''    public ScopeElement[] getExcludes()
    '''
def hasExcludes():
    '''    public boolean hasExcludes()
    '''
def setExcludes():
    '''    public void setExcludes(final ScopeElement[] excludes)
    '''
def getGuid():
    '''    public Guid getGuid()
    '''
