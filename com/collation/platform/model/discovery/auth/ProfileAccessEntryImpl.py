def ProfileAccessEntryImpl():
    '''    public ProfileAccessEntryImpl()
    public ProfileAccessEntryImpl(final Map m)
    '''
def getParent():
    '''    public DiscoveryProfile getParent()
    '''
def hasParent():
    '''    public boolean hasParent()
    '''
def setParent():
    '''    public void setParent(final DiscoveryProfile parent)
    '''
def getGuid():
    '''    public Guid getGuid()
    '''
