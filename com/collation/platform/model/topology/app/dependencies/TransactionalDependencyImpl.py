def ():
    '''returns TransactionalDependencyImpl\n\n
    ()\n
    (final Map m)\n
    '''
def getType():
...
def setSource():
    '''returns None\n\n
    setSource(final ModelObject id)\n
    '''
def getTarget():
    '''returns ModelObject\n\n
    getTarget()\n
...
def setTarget():
    '''returns None\n\n
    setTarget(final ModelObject id)\n
    '''
def getGenerated():
    '''returns boolean\n\n
    getGenerated()\n
...
def getOriginalSource():
    ...
    getOriginalSource()\n
    '''
def hasOriginalSource():
    '''returns boolean\n\n
    hasOriginalSource()\n
    '''
def setOriginalSource():
    '''returns None\n\n
    setOriginalSource(final Guid s)\n
    '''
def toString():
    '''returns String\n\n
    toString()\n
