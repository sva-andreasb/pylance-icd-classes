...
def setProfileRegistry():
    '''returns None\n\n
    setProfileRegistry(final Db2SystemConfigValue[] values)\n
    '''
def getInstances():
    '''returns Db2Instance[]\n\n
    getInstances()\n
...
def setInstances():
    '''returns None\n\n
    setInstances(final Db2Instance[] db)\n
    '''
def getLicenseInfo():
    '''returns Db2SystemConfigValue[]\n\n
    getLicenseInfo()\n
...
def setLicenseInfo():
    '''returns None\n\n
    setLicenseInfo(final Db2SystemConfigValue[] lic)\n
    '''
def getAdminServer():
    '''returns Db2AdminServer\n\n
    getAdminServer()\n
    '''
def hasAdminServer():
    '''returns boolean\n\n
...
def setAdminServer():
    '''returns None\n\n
    setAdminServer(final Db2AdminServer das)\n
    '''
