def ():
    '''returns DefinitiveSoftwareLibraryImpl\n\n
    ()\n
    (final Map m)\n
    '''
def getDSLName():
...
def setDSLName():
    '''returns None\n\n
    setDSLName(final String s)\n
    '''
def getImages():
    '''returns SoftwareImage[]\n\n
    getImages()\n
    '''
def hasImages():
    '''returns boolean\n\n
...
def setImages():
    '''returns None\n\n
    setImages(final SoftwareImage[] images)\n
    '''
def getPrimaryOwner():
...
def setCICategory():
    '''returns None\n\n
    setCICategory(final String cat)\n
    '''
...
def setLifecycleState():
    '''returns None\n\n
    setLifecycleState(final int state)\n
    '''
...
def setLastAuditState():
    '''returns None\n\n
    setLastAuditState(final int state)\n
    '''
...
def setLastAuditTime():
    '''returns None\n\n
    setLastAuditTime(final long time)\n
    '''
...
def setLastLifecycleStateTime():
    '''returns None\n\n
    setLastLifecycleStateTime(final long time)\n
    '''
def getAssetTag():
    '''returns String\n\n
    getAssetTag()\n
