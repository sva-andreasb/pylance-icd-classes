...
def setFolderDN():
    '''returns None\n\n
    setFolderDN(final String x)\n
    '''
def getParent():
    '''returns CitrixFolder\n\n
    getParent()\n
    '''
def hasParent():
    '''returns boolean\n\n
...
def setParent():
    '''returns None\n\n
    setParent(final CitrixFolder x)\n
    '''
def getFolders():
    '''returns CitrixFolder[]\n\n
    getFolders()\n
...
def setFolders():
    '''returns None\n\n
    setFolders(final CitrixFolder[] x)\n
    '''
def getFolderName():
    '''returns String\n\n
    getFolderName()\n
...
def setMemberType():
    '''returns None\n\n
    setMemberType(final String type)\n
    '''
def toString():
    '''returns String\n\n
    toString()\n
