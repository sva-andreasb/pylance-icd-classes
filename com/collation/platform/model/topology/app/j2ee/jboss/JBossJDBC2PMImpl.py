def ():
    '''returns JBossJDBC2PMImpl\n\n
    ()\n
    (final Map m)\n
    '''
def getConnectionRetryAttempts():
    '''returns int\n\n
    getConnectionRetryAttempts()\n
    '''
def hasConnectionRetryAttempts():
    '''returns boolean\n\n
    hasConnectionRetryAttempts()\n
    '''
def setConnectionRetryAttempts():
    '''returns None\n\n
    setConnectionRetryAttempts(final int attempts)\n
    '''
def getSqlProperties():
    '''returns String\n\n
    getSqlProperties()\n
    '''
def hasSqlProperties():
    '''returns boolean\n\n
    hasSqlProperties()\n
    '''
def setSqlProperties():
    '''returns None\n\n
    setSqlProperties(final String properties)\n
    '''
