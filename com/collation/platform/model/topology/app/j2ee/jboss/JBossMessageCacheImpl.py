...
def setInstance():
    '''returns None\n\n
    setInstance(final int instance)\n
    '''
def getJBossPersistenceManager():
    '''returns JBossPersistenceManager\n\n
    getJBossPersistenceManager()\n
    '''
def hasJBossPersistenceManager():
    '''returns boolean\n\n
    hasJBossPersistenceManager()\n
    '''
def setJBossPersistenceManager():
    '''returns None\n\n
    setJBossPersistenceManager(final JBossPersistenceManager manager)\n
    '''
def getHighMemoryMark():
    '''returns long\n\n
    getHighMemoryMark()\n
    '''
def hasHighMemoryMark():
    '''returns boolean\n\n
    hasHighMemoryMark()\n
    '''
def setHighMemoryMark():
    '''returns None\n\n
    setHighMemoryMark(final long highmark)\n
    '''
def getMaxMemoryMark():
    '''returns long\n\n
    getMaxMemoryMark()\n
    '''
def hasMaxMemoryMark():
    '''returns boolean\n\n
    hasMaxMemoryMark()\n
    '''
def setMaxMemoryMark():
    '''returns None\n\n
    setMaxMemoryMark(final long name)\n
    '''
