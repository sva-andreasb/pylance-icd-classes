...
def setName():
    ...
    '''
def getDestinationManager():
    '''returns JBossDestinationManager\n\n
    getDestinationManager()\n
    '''
def hasDestinationManager():
    '''returns boolean\n\n
    hasDestinationManager()\n
    '''
def setDestinationManager():
    '''returns None\n\n
    setDestinationManager(final JBossDestinationManager manager)\n
    '''
def getJBossInvocationLayer():
    '''returns JBossInvocationLayer[]\n\n
    getJBossInvocationLayer()\n
    '''
def hasJBossInvocationLayer():
    '''returns boolean\n\n
    hasJBossInvocationLayer()\n
    '''
def setJBossInvocationLayer():
    '''returns None\n\n
    setJBossInvocationLayer(final JBossInvocationLayer[] layers)\n
    '''
