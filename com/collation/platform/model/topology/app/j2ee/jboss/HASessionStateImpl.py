...
def setStateString():
    ...
    '''
def getBeanCleaningDelay():
    '''returns long\n\n
    getBeanCleaningDelay()\n
    '''
def hasBeanCleaningDelay():
    '''returns boolean\n\n
    hasBeanCleaningDelay()\n
    '''
def setBeanCleaningDelay():
    '''returns None\n\n
    setBeanCleaningDelay(final long count)\n
    '''
def getName():
    '''returns String\n\n
    getName()\n
