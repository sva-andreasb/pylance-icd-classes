def ():
    '''returns JBossDestinationManagerImpl\n\n
    ()\n
    (final Map m)\n
    '''
def getName():
...
def setMessageCache():
    '''returns None\n\n
    setMessageCache(final JBossMessageCache cache)\n
    '''
def getJBossDestinations():
    '''returns JBossDestination[]\n\n
    getJBossDestinations()\n
    '''
def hasJBossDestinations():
    '''returns boolean\n\n
    hasJBossDestinations()\n
    '''
def setJBossDestinations():
    '''returns None\n\n
    setJBossDestinations(final JBossDestination[] dest)\n
    '''
def getParent():
    '''returns J2EEDomain\n\n
    getParent()\n
