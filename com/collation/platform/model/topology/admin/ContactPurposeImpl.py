...
def setParent():
    '''returns None\n\n
    setParent(final OrganizationalEntity x)\n
    '''
def getContactPurposePriority():
    '''returns int\n\n
    getContactPurposePriority()\n
    '''
def hasContactPurposePriority():
    '''returns boolean\n\n
    hasContactPurposePriority()\n
    '''
def setContactPurposePriority():
    '''returns None\n\n
    setContactPurposePriority(final int x)\n
    '''
def getPurposeType():
    '''returns int\n\n
    getPurposeType()\n
...
def setPurposeType():
    '''returns None\n\n
    setPurposeType(final int x)\n
    '''
def getGeneralPurposeType():
    '''returns String\n\n
    getGeneralPurposeType()\n
    '''
def hasGeneralPurposeType():
    '''returns boolean\n\n
    hasGeneralPurposeType()\n
    '''
def setGeneralPurposeType():
    '''returns None\n\n
    setGeneralPurposeType(final String x)\n
    '''
