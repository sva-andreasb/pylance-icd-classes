def ():
    '''returns AdminInfoImpl\n\n
    ()\n
    (final Map m)\n
    '''
def getEscalationContact():
    '''returns String\n\n
    getEscalationContact()\n
    '''
def hasEscalationContact():
    '''returns boolean\n\n
    hasEscalationContact()\n
    '''
def setEscalationContact():
    '''returns None\n\n
    setEscalationContact(final String x)\n
    '''
def getSite():
    '''returns String\n\n
    getSite()\n
...
def setAdminContact():
    '''returns None\n\n
    setAdminContact(final String x)\n
    '''
def getAppGroupName():
    '''returns String\n\n
    getAppGroupName()\n
...
def setAppGroupName():
    '''returns None\n\n
    setAppGroupName(final String x)\n
    '''
def getObjGuid():
    '''returns Guid\n\n
    getObjGuid()\n
...
def setObjGuid():
    '''returns None\n\n
    setObjGuid(final Guid x)\n
    '''
def getTrackingNumber():
    '''returns String\n\n
    getTrackingNumber()\n
    '''
def hasTrackingNumber():
    '''returns boolean\n\n
    hasTrackingNumber()\n
    '''
def setTrackingNumber():
    '''returns None\n\n
    setTrackingNumber(final String x)\n
    '''
