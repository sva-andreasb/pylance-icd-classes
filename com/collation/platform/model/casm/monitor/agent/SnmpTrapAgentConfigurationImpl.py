def SnmpTrapAgentConfigurationImpl():
'''public SnmpTrapAgentConfigurationImpl()
public SnmpTrapAgentConfigurationImpl(final Map m)
'''
pass
def getTrapPort():
...
pass
def setTrapMapper():
'''public void setTrapMapper(final String mapper)
'''
pass
...
'''public void setUseTCPTransport(final boolean useTCPTransport)
'''
pass
def getGuid():
'''public Guid getGuid()
