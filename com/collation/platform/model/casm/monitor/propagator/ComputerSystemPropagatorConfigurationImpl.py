def ():
    '''returns ComputerSystemPropagatorConfigurationImpl\n\n
    ()\n
    (final Map m)\n
    '''
...
def setDirectAppServerPropagationDelta():
    '''returns None\n\n
    setDirectAppServerPropagationDelta(final int delta)\n
    '''
...
def setDependentAppServerPropagationDelta():
    '''returns None\n\n
    setDependentAppServerPropagationDelta(final int delta)\n
    '''
...
def setMergeThresholdPercentage():
    '''returns None\n\n
    setMergeThresholdPercentage(final int percentage)\n
    '''
...
def setAppServerPropagation():
    '''returns None\n\n
    setAppServerPropagation(final boolean enabled)\n
    '''
def getGuid():
    '''returns Guid\n\n
    getGuid()\n
...
def setPropagatorClassName():
    '''returns None\n\n
    setPropagatorClassName(final String name)\n
    '''
def getLevel():
    '''returns int\n\n
    getLevel()\n
...
def setCategory():
    '''returns None\n\n
    setCategory(final int category)\n
    '''
...
def setDependentPropagation():
    '''returns None\n\n
    setDependentPropagation(final boolean enabled)\n
    '''
...
def setContainerPropagation():
    '''returns None\n\n
    setContainerPropagation(final boolean enabled)\n
    '''
def getName():
    '''returns String\n\n
    getName()\n
