def BusinessServicePropagatorConfigurationImpl():
    '''public BusinessServicePropagatorConfigurationImpl()
    public BusinessServicePropagatorConfigurationImpl(final Map m)
    '''
def getGuid():
    '''public Guid getGuid()
    '''
