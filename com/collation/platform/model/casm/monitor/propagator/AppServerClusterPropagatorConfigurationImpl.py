def AppServerClusterPropagatorConfigurationImpl():
    '''public AppServerClusterPropagatorConfigurationImpl()
    public AppServerClusterPropagatorConfigurationImpl(final Map m)
    '''
def getGuid():
    '''public Guid getGuid()
    '''
