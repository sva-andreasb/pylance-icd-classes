def SyncScheduleImpl():
    '''    public SyncScheduleImpl()
    public SyncScheduleImpl(final Map m)
    '''
def setParent():
    '''    public void setParent(final CMDBDomain domain)
    '''
def getParent():
    '''    public CMDBDomain getParent()
    '''
def hasParent():
...
def hasInterval():
    ...
    '''
def setSyncLog():
    '''    public void setSyncLog(final String log)
    '''
def getSyncLog():
    '''    public String getSyncLog()
    '''
def hasSyncLog():
    '''    public boolean hasSyncLog()
    '''
def setSyncStatus():
    '''    public void setSyncStatus(final int status)
    '''
def getSyncStatus():
