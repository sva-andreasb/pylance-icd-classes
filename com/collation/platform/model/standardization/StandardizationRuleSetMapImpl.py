def ():
    '''returns StandardizationRuleSetMapImpl\n\n
    ()\n
    (final Map m)\n
    '''
def getObject():
...
def setAttribute():
    '''returns None\n\n
    setAttribute(final String attribute)\n
    '''
def getStandardizationRuleSet():
    '''returns StandardizationRuleSet\n\n
    getStandardizationRuleSet()\n
    '''
def hasStandardizationRuleSet():
    '''returns boolean\n\n
    hasStandardizationRuleSet()\n
    '''
def setStandardizationRuleSet():
    '''returns None\n\n
    setStandardizationRuleSet(final StandardizationRuleSet ruleSet)\n
    '''
def getGuid():
    '''returns Guid\n\n
    getGuid()\n
