def ():
    '''returns StandardizationRuleSetImpl\n\n
    ()\n
    (final Map m)\n
    '''
def getName():
...
def setName():
    ...
    '''
def getStandardizationRules():
    '''returns StandardizationRule[]\n\n
    getStandardizationRules()\n
    '''
def hasStandardizationRules():
    '''returns boolean\n\n
    hasStandardizationRules()\n
    '''
def setStandardizationRules():
    '''returns None\n\n
    setStandardizationRules(final StandardizationRule[] rules)\n
    '''
def getGuid():
    '''returns Guid\n\n
    getGuid()\n
