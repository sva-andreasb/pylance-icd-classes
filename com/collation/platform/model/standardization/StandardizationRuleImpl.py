def ():
    '''returns StandardizationRuleImpl\n\n
    ()\n
    (final Map m)\n
    '''
def getAllowableValue():
    '''returns String\n\n
    getAllowableValue()\n
    '''
def hasAllowableValue():
    '''returns boolean\n\n
    hasAllowableValue()\n
    '''
def setAllowableValue():
    '''returns None\n\n
    setAllowableValue(final String allowableValue)\n
    '''
def getReplacementValue():
    '''returns String\n\n
    getReplacementValue()\n
    '''
def hasReplacementValue():
    '''returns boolean\n\n
    hasReplacementValue()\n
    '''
def setReplacementValue():
    '''returns None\n\n
    setReplacementValue(final String replacementValue)\n
    '''
def getGuid():
    '''returns Guid\n\n
    getGuid()\n
