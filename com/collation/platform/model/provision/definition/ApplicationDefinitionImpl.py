def ApplicationDefinitionImpl():
    '''    public ApplicationDefinitionImpl()
    public ApplicationDefinitionImpl(final Map m)
    '''
def setName():
...
def hasName():
    ...
    '''
def setDefVersion():
    '''    public void setDefVersion(final String s)
    '''
def getDefVersion():
...
def hasDefVersion():
    ...
    '''
def setModuleDefinitions():
    '''    public void setModuleDefinitions(final ModuleDefinition[] s)
    '''
def getModuleDefinitions():
    '''    public ModuleDefinition[] getModuleDefinitions()
    '''
def hasModuleDefinitions():
    '''    public boolean hasModuleDefinitions()
    '''
def setActions():
    '''    public void setActions(final Action[] s)
    '''
def getActions():
...
def hasActions():
    ...
    '''
def setParameters():
    '''    public void setParameters(final Parameter[] s)
    '''
def getParameters():
...
def hasParameters():
    ...
    '''
def setWorkflows():
    '''    public void setWorkflows(final Workflow[] workflows)
    '''
def getWorkflows():
