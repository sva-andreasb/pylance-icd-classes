def ():
    '''returns ApplicationDeploymentPlanImpl\n\n
    ()\n
    (final Map m)\n
    '''
def setPreviousDeploymentPlan():
    '''returns None\n\n
    setPreviousDeploymentPlan(final String s)\n
    '''
...
def setApplicationDefinitionName():
    '''returns None\n\n
    setApplicationDefinitionName(final String s)\n
    '''
...
def setApplicationDefinitionVersion():
    '''returns None\n\n
    setApplicationDefinitionVersion(final String s)\n
    '''
...
def setWorkflowDefinition():
    '''returns None\n\n
    setWorkflowDefinition(final Workflow workflow)\n
    '''
...
def setModuleMappings():
    '''returns None\n\n
    setModuleMappings(final ModuleMapping[] s)\n
    '''
