def ContainerInstanceImpl():
    '''    public ContainerInstanceImpl()
    public ContainerInstanceImpl(final Map m)
    '''
def setSid():
...
def hasSid():
    ...
    '''
def setPort():
    '''    public void setPort(final long s)
    '''
def getPort():
    '''    public long getPort()
    '''
def hasPort():
    ...
    '''
def setHostId():
    '''    public void setHostId(final String s)
    '''
def getHostId():
...
def hasHostId():
    ...
    '''
def setObjectId():
    '''    public void setObjectId(final Guid id)
    '''
def getObjectId():
