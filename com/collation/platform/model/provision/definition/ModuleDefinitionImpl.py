...
def hasType():
    ...
    hasType()\n
    '''
def setPackageDefinitions():
    '''returns None\n\n
    setPackageDefinitions(final PackageDefinition[] s)\n
    '''
def getPackageDefinitions():
    '''returns PackageDefinition[]\n\n
    getPackageDefinitions()\n
    '''
def hasPackageDefinitions():
    '''returns boolean\n\n
    hasPackageDefinitions()\n
    '''
def setHostConstraint():
    '''returns None\n\n
    setHostConstraint(final HostConstraint s)\n
    '''
def getHostConstraint():
    '''returns HostConstraint\n\n
    getHostConstraint()\n
    '''
def hasHostConstraint():
    '''returns boolean\n\n
    hasHostConstraint()\n
    '''
def setContainerConstraint():
    '''returns None\n\n
    setContainerConstraint(final ContainerConstraint s)\n
    '''
def getContainerConstraint():
    '''returns ContainerConstraint\n\n
    getContainerConstraint()\n
    '''
def hasContainerConstraint():
    '''returns boolean\n\n
    hasContainerConstraint()\n
    '''
def setActions():
    '''returns None\n\n
    setActions(final Action[] s)\n
    '''
def getActions():
    '''returns Action[]\n\n
    getActions()\n
...
def setParameters():
    '''returns None\n\n
    setParameters(final Parameter[] s)\n
    '''
def getParameters():
    '''returns Parameter[]\n\n
    getParameters()\n
