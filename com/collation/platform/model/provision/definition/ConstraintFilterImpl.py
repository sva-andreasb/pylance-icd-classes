def ConstraintFilterImpl():
    '''public ConstraintFilterImpl()
    public ConstraintFilterImpl(final Map m)
    '''
def setParent():
    '''public void setParent(final Constraint s)
    '''
def getParent():
...
def hasParent():
    ...
    '''
def setQuery():
    '''public void setQuery(final String s)
    '''
def getQuery():
