def ():
    '''returns ModuleMappingImpl\n\n
    ()\n
    (final Map m)\n
    '''
def setModuleDefinitionName():
    '''returns None\n\n
    setModuleDefinitionName(final String s)\n
    '''
def getModuleDefinitionName():
    '''returns String\n\n
    getModuleDefinitionName()\n
    '''
def hasModuleDefinitionName():
    '''returns boolean\n\n
    hasModuleDefinitionName()\n
    '''
def setModuleDefinitionVersion():
    '''returns None\n\n
    setModuleDefinitionVersion(final String s)\n
    '''
def getModuleDefinitionVersion():
    '''returns String\n\n
    getModuleDefinitionVersion()\n
    '''
def hasModuleDefinitionVersion():
    '''returns boolean\n\n
    hasModuleDefinitionVersion()\n
    '''
def setHostInstances():
    '''returns None\n\n
    setHostInstances(final HostInstance[] s)\n
    '''
def getHostInstances():
    '''returns HostInstance[]\n\n
    getHostInstances()\n
    '''
def hasHostInstances():
    '''returns boolean\n\n
    hasHostInstances()\n
    '''
def setContainerInstances():
    '''returns None\n\n
    setContainerInstances(final ContainerInstance[] s)\n
    '''
def getContainerInstances():
    '''returns ContainerInstance[]\n\n
    getContainerInstances()\n
    '''
def hasContainerInstances():
    '''returns boolean\n\n
