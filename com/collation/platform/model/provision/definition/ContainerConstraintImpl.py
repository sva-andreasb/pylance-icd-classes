def ContainerConstraintImpl():
    '''    public ContainerConstraintImpl()
    public ContainerConstraintImpl(final Map m)
    '''
def setName():
...
def hasName():
    ...
    '''
def setOperand():
    '''    public void setOperand(final String s)
    '''
def getOperand():
...
def hasOwner():
    ...
    '''
def setFilters():
    '''    public void setFilters(final ConstraintFilter[] s)
    '''
def getFilters():
    '''    public ConstraintFilter[] getFilters()
    '''
def hasFilters():
