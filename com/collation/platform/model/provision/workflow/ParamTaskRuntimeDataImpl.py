def ():
    '''returns ParamTaskRuntimeDataImpl\n\n
    ()\n
    (final Map m)\n
    '''
...
def setApplicationName():
    '''returns None\n\n
    setApplicationName(final String name)\n
    '''
def getModuleName():
    '''returns String\n\n
    getModuleName()\n
...
def setModuleName():
    '''returns None\n\n
    setModuleName(final String name)\n
    '''
def getPackageName():
    '''returns String\n\n
    getPackageName()\n
...
def setPackageName():
    '''returns None\n\n
    setPackageName(final String name)\n
    '''
def getParameterName():
    '''returns String\n\n
    getParameterName()\n
    '''
def hasParameterName():
    '''returns boolean\n\n
    hasParameterName()\n
    '''
def setParameterName():
    '''returns None\n\n
    setParameterName(final String name)\n
    '''
def getObjectId():
    '''returns Guid\n\n
    getObjectId()\n
...
def setParent():
    '''returns None\n\n
    setParent(final TaskRuntime parent)\n
    '''
def toString():
    '''returns String\n\n
    toString()\n
