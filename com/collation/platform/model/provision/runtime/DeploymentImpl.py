def ():
    '''returns DeploymentImpl\n\n
    ()\n
    (final Map m)\n
    '''
def setDeploymentPlan():
    '''returns None\n\n
    setDeploymentPlan(final ApplicationDeploymentPlan s)\n
    '''
def getDeploymentPlan():
    '''returns ApplicationDeploymentPlan\n\n
    getDeploymentPlan()\n
    '''
def hasDeploymentPlan():
    '''returns boolean\n\n
    hasDeploymentPlan()\n
    '''
def setWorkflowRuntime():
    '''returns None\n\n
    setWorkflowRuntime(final WorkflowRuntime wfr)\n
    '''
def setStatus():
    '''returns None\n\n
...
def hasStatus():
    ...
    hasStatus()\n
    '''
def getWorkflowRuntime():
    '''returns WorkflowRuntime\n\n
    getWorkflowRuntime()\n
    '''
def hasWorkflowRuntime():
    '''returns boolean\n\n
    hasWorkflowRuntime()\n
    '''
def setParamMap():
    '''returns None\n\n
    setParamMap(final ParamMap s)\n
    '''
def getParamMap():
    '''returns ParamMap\n\n
    getParamMap()\n
...
def setAuditLog():
    '''returns None\n\n
    setAuditLog(final AuditEntry[] aes)\n
    '''
def getAuditLog():
    '''returns AuditEntry[]\n\n
    getAuditLog()\n
