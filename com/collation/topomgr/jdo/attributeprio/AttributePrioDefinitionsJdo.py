def getClassName():
    ...
    '''
def ():
    '''returns AttributePrioDefinitionsJdo\n\n
...
def setPrioClassName():
    '''returns None\n\n
    setPrioClassName(final String a)\n
    '''
...
def setPriorityString():
    '''returns None\n\n
    setPriorityString(final String a)\n
    '''
...
def setPrioAttributeName():
    '''returns None\n\n
    setPrioAttributeName(final String a)\n
    '''
...
def sameJdo():
    '''returns boolean\n\n
    sameJdo(final AttributePrioDefinitions obj, final Map objKeys, final TopologyActionContext ctx, final JdoUpdateMap updateMap)\n
    '''
def sameJdoTest():
    '''returns boolean\n\n
    sameJdoTest(final AttributePrioDefinitions obj, final TopologyActionContext ctx, final JdoUpdateMap updateMap)\n
    '''
def similarJdo():
    '''returns boolean\n\n
    similarJdo(final AttributePrioDefinitionsJdo obj)\n
    '''
def updateJdoByObj():
    '''returns None\n\n
    updateJdoByObj(final AttributePrioDefinitions obj, final List guidMap, final TopologyActionContext ctx, final Set processedObjs, final JdoUpdateMap updateMap, final Map stknGuidMap, final String attrPriosFromDb)\n
    '''
def copyJdo():
    '''returns None\n\n
...
def removeJdo():
    '''returns Set\n\n
    removeJdo(final TopologyActionContext ctx)\n
    removeJdo(final TopologyActionContext ctx, final Set removedGuidSet)\n
    '''
def removeJdoRefs():
    '''returns None\n\n
