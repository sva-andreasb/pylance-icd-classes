def getClassName():
    ...
    '''
def ():
    '''returns IpInterfacePropagatorConfigurationJdo\n\n
...
def setThresholdPercentage():
    '''returns None\n\n
    setThresholdPercentage(final int a)\n
    '''
...
def setComputerSystemPropagation():
    '''returns None\n\n
    setComputerSystemPropagation(final boolean a)\n
    '''
...
def sameJdo():
    '''returns boolean\n\n
    sameJdo(final IpInterfacePropagatorConfiguration obj, final Map objKeys, final TopologyActionContext ctx, final JdoUpdateMap updateMap)\n
    '''
def sameJdoTest():
    '''returns boolean\n\n
    sameJdoTest(final IpInterfacePropagatorConfiguration obj, final TopologyActionContext ctx, final JdoUpdateMap updateMap)\n
    '''
def similarJdo():
    '''returns boolean\n\n
    similarJdo(final IpInterfacePropagatorConfigurationJdo obj)\n
    '''
def updateJdoByObj():
    '''returns None\n\n
    updateJdoByObj(final IpInterfacePropagatorConfiguration obj, final List guidMap, final TopologyActionContext ctx, final Set processedObjs, final JdoUpdateMap updateMap, final Map stknGuidMap, final String attrPriosFromDb)\n
    '''
def copyJdo():
    '''returns None\n\n
