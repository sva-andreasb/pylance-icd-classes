def getClassName():
    ...
    '''
def ():
    '''returns DominoServerAgentConfigurationJdo\n\n
    (final Guid guid, final TopologyActionContext ctx)\n
    ()\n
    '''
def getIIOPServers():
    '''returns DominoIIOPServer[]\n\n
    getIIOPServers()\n
    '''
def setIIOPServers():
    '''returns None\n\n
    setIIOPServers(final DominoIIOPServer[] a)\n
    '''
def hasIIOPServers():
    '''returns boolean\n\n
    hasIIOPServers()\n
...
def addIIOPServers():
    '''returns boolean\n\n
    addIIOPServers(final DominoIIOPServer obj)\n
    '''
def removeIIOPServers():
    '''returns boolean\n\n
    removeIIOPServers(final DominoIIOPServer obj)\n
    '''
...
def sameJdo():
    '''returns boolean\n\n
    sameJdo(final DominoServerAgentConfiguration obj, final Map objKeys, final TopologyActionContext ctx, final JdoUpdateMap updateMap)\n
    '''
def sameJdoTest():
    '''returns boolean\n\n
    sameJdoTest(final DominoServerAgentConfiguration obj, final TopologyActionContext ctx, final JdoUpdateMap updateMap)\n
    '''
def similarJdo():
    '''returns boolean\n\n
    similarJdo(final DominoServerAgentConfigurationJdo obj)\n
    '''
def updateJdoByObj():
    '''returns None\n\n
    updateJdoByObj(final DominoServerAgentConfiguration obj, final List guidMap, final TopologyActionContext ctx, final Set processedObjs, final JdoUpdateMap updateMap, final Map stknGuidMap, final String attrPriosFromDb)\n
    '''
def copyJdo():
    '''returns None\n\n
