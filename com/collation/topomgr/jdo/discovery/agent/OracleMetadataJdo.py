...
def getSchemaObjects():
    '''returns OracleSchemaProps[]\n\n
    getSchemaObjects()\n
    '''
def setSchemaObjects():
    '''returns None\n\n
    setSchemaObjects(final OracleSchemaProps[] a)\n
    '''
def hasSchemaObjects():
    '''returns boolean\n\n
    hasSchemaObjects()\n
    '''
def addSchemaObjects():
    '''returns boolean\n\n
    addSchemaObjects(final OracleSchemaProps obj)\n
    '''
def removeSchemaObjects():
    '''returns boolean\n\n
    removeSchemaObjects(final OracleSchemaProps obj)\n
    '''
def getObjectType():
    '''returns String\n\n
    getObjectType()\n
...
def sameJdo():
    '''returns boolean\n\n
    sameJdo(final OracleMetadata obj, final Map objKeys, final TopologyActionContext ctx, final JdoUpdateMap updateMap)\n
    '''
def sameJdoTest():
    '''returns boolean\n\n
    sameJdoTest(final OracleMetadata obj, final TopologyActionContext ctx, final JdoUpdateMap updateMap)\n
    '''
def similarJdo():
    '''returns boolean\n\n
    similarJdo(final OracleMetadataJdo obj)\n
    '''
def updateJdoByObj():
    '''returns None\n\n
    updateJdoByObj(final OracleMetadata obj, final List guidMap, final TopologyActionContext ctx, final Set processedObjs, final JdoUpdateMap updateMap, final Map stknGuidMap, final String attrPriosFromDb)\n
    '''
def copyJdo():
    '''returns None\n\n
