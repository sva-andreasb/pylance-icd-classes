def getClassName():
    ...
    '''
def ():
    '''returns VeritasClusterMappingJdo\n\n
...
def hasAttrPrios():
    ...
    '''
def getAttrMappings():
    '''returns VeritasClusterAttrMapping[]\n\n
    getAttrMappings()\n
    '''
def setAttrMappings():
    '''returns None\n\n
    setAttrMappings(final VeritasClusterAttrMapping[] a)\n
    '''
def hasAttrMappings():
    '''returns boolean\n\n
    hasAttrMappings()\n
...
def addAttrMappings():
    '''returns boolean\n\n
    addAttrMappings(final VeritasClusterAttrMapping obj)\n
    '''
def removeAttrMappings():
    '''returns boolean\n\n
    removeAttrMappings(final VeritasClusterAttrMapping obj)\n
    '''
def getModelClass():
    '''returns String\n\n
    getModelClass()\n
...
def sameJdo():
    '''returns boolean\n\n
    sameJdo(final VeritasClusterMapping obj, final Map objKeys, final TopologyActionContext ctx, final JdoUpdateMap updateMap)\n
    '''
def sameJdoTest():
    '''returns boolean\n\n
    sameJdoTest(final VeritasClusterMapping obj, final TopologyActionContext ctx, final JdoUpdateMap updateMap)\n
    '''
def similarJdo():
    '''returns boolean\n\n
    similarJdo(final VeritasClusterMappingJdo obj)\n
    '''
def updateJdoByObj():
    '''returns None\n\n
    updateJdoByObj(final VeritasClusterMapping obj, final List guidMap, final TopologyActionContext ctx, final Set processedObjs, final JdoUpdateMap updateMap, final Map stknGuidMap, final String attrPriosFromDb)\n
    '''
def copyJdo():
    '''returns None\n\n
