...
def setDocumentName():
    '''returns None\n\n
    setDocumentName(final String a)\n
    '''
def hasDocumentName():
    '''returns boolean\n\n
    hasDocumentName()\n
...
def setDatabaseName():
    '''returns None\n\n
    setDatabaseName(final String a)\n
    '''
def hasDatabaseName():
    '''returns boolean\n\n
    hasDatabaseName()\n
...
def sameJdo():
    '''returns boolean\n\n
    sameJdo(final AdditionalFields obj, final Map objKeys, final TopologyActionContext ctx, final JdoUpdateMap updateMap)\n
    '''
def sameJdoTest():
    '''returns boolean\n\n
    sameJdoTest(final AdditionalFields obj, final TopologyActionContext ctx, final JdoUpdateMap updateMap)\n
    '''
def similarJdo():
    '''returns boolean\n\n
    similarJdo(final AdditionalFieldsJdo obj)\n
    '''
def updateJdoByObj():
    '''returns None\n\n
    updateJdoByObj(final AdditionalFields obj, final List guidMap, final TopologyActionContext ctx, final Set processedObjs, final JdoUpdateMap updateMap, final Map stknGuidMap, final String attrPriosFromDb)\n
    '''
def copyJdo():
    '''returns None\n\n
