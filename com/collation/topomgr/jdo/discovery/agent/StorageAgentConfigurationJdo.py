def getClassName():
    ...
    '''
def ():
    '''returns StorageAgentConfigurationJdo\n\n
...
def setActiveDisksOnly():
    '''returns None\n\n
    setActiveDisksOnly(final boolean a)\n
    '''
...
def setFdiskCommand():
    '''returns None\n\n
    setFdiskCommand(final String a)\n
    '''
def hasFdiskCommand():
    '''returns boolean\n\n
    hasFdiskCommand()\n
...
def sameJdo():
    '''returns boolean\n\n
    sameJdo(final StorageAgentConfiguration obj, final Map objKeys, final TopologyActionContext ctx, final JdoUpdateMap updateMap)\n
    '''
def sameJdoTest():
    '''returns boolean\n\n
    sameJdoTest(final StorageAgentConfiguration obj, final TopologyActionContext ctx, final JdoUpdateMap updateMap)\n
    '''
def similarJdo():
    '''returns boolean\n\n
    similarJdo(final StorageAgentConfigurationJdo obj)\n
    '''
def updateJdoByObj():
    '''returns None\n\n
    updateJdoByObj(final StorageAgentConfiguration obj, final List guidMap, final TopologyActionContext ctx, final Set processedObjs, final JdoUpdateMap updateMap, final Map stknGuidMap, final String attrPriosFromDb)\n
    '''
def copyJdo():
    '''returns None\n\n
