...
def setContactEMail():
    ...
    '''
def getOutputs():
    '''    public BaseClassArrayProp getOutputs()
    '''
def setOutputs():
    '''    public void setOutputs(final BaseClassArrayProp outputs)
    '''
def getSelectionContext():
    '''    public XmlEncodedXMLProp getSelectionContext()
    '''
def setSelectionContext():
    '''    public void setSelectionContext(final XmlEncodedXMLProp selectionContext)
    '''
def equals():
