...
def setEventKey():
    ...
    '''
def getSequencing():
    '''public NmtokenProp getSequencing()
    '''
def setSequencing():
    '''public void setSequencing(final NmtokenProp sequencing)
    '''
def equals():
