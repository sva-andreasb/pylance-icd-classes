...
def setContactEMail():
    ...
    '''
def getCubeContentName():
    '''    public StringProp getCubeContentName()
    '''
def setCubeContentName():
    '''    public void setCubeContentName(final StringProp cubeContentName)
    '''
def getDataBlocks():
    '''    public PowerPlayDataBlockArrayProp getDataBlocks()
    '''
def setDataBlocks():
    '''    public void setDataBlocks(final PowerPlayDataBlockArrayProp dataBlocks)
    '''
def getGateway():
    '''    public AnyURIProp getGateway()
    '''
def setGateway():
    '''    public void setGateway(final AnyURIProp gateway)
    '''
def getOptions():
    '''    public PowerPlayOptionArrayProp getOptions()
    '''
def setOptions():
    '''    public void setOptions(final PowerPlayOptionArrayProp options)
    '''
def getPackageBase():
