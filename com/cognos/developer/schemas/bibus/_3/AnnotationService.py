...
def setAnsAnnotationLifetime():
    '''    public void setAnsAnnotationLifetime(final DurationProp ansAnnotationLifetime)
    '''
def getAnsAuditLevel():
    '''    public AuditLevelEnumProp getAnsAuditLevel()
    '''
def setAnsAuditLevel():
    '''    public void setAnsAuditLevel(final AuditLevelEnumProp ansAuditLevel)
    '''
def getRunningState():
