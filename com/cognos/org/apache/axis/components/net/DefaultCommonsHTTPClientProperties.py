MAXIMUM_TOTAL_CONNECTIONS_PROPERTY_KEY = "String  \"axis.http.client.maximum.total.connections\""
MAXIMUM_CONNECTIONS_PER_HOST_PROPERTY_KEY = "String  \"axis.http.client.maximum.connections.per.host\""
CONNECTION_POOL_TIMEOUT_KEY = "String  \"axis.http.client.connection.pool.timeout\""
