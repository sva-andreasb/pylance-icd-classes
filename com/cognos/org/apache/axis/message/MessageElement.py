...
def setIdAttribute():
    '''returns None\n\n
    setIdAttribute(final String arg0, final boolean arg1)\n
    '''
def setIdAttributeNS():
    '''returns None\n\n
    setIdAttributeNS(final String arg0, final String arg1, final boolean arg2)\n
    '''
def setIdAttributeNode():
    '''returns None\n\n
    setIdAttributeNode(final Attr arg0, final boolean arg1)\n
    '''
