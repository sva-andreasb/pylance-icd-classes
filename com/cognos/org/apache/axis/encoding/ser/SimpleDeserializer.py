def SimpleDeserializer():
'''public SimpleDeserializer(final Class javaType, final QName xmlType)
public SimpleDeserializer(final Class javaType, final QName xmlType, final TypeDesc typeDesc)
'''
pass
def reset():
'''public void reset()
