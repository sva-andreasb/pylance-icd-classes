...
def parse():
    ...
    public static CTLock parse(final URL url)
    public static CTLock parse(final URL url, final XmlOptions xmlOptions)
    public static CTLock parse(final InputStream inputStream)
    public static CTLock parse(final InputStream inputStream, final XmlOptions xmlOptions)
    public static CTLock parse(final Reader reader)
    public static CTLock parse(final Reader reader, final XmlOptions xmlOptions)
    public static CTLock parse(final XMLStreamReader xmlStreamReader)
    public static CTLock parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions)
    public static CTLock parse(final Node node)
    public static CTLock parse(final Node node, final XmlOptions xmlOptions)
    public static CTLock parse(final XMLInputStream xmlInputStream)
