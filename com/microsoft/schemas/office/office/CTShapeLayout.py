...
def parse():
    ...
    public static CTShapeLayout parse(final URL url)
    public static CTShapeLayout parse(final URL url, final XmlOptions xmlOptions)
    public static CTShapeLayout parse(final InputStream inputStream)
    public static CTShapeLayout parse(final InputStream inputStream, final XmlOptions xmlOptions)
    public static CTShapeLayout parse(final Reader reader)
    public static CTShapeLayout parse(final Reader reader, final XmlOptions xmlOptions)
    public static CTShapeLayout parse(final XMLStreamReader xmlStreamReader)
    public static CTShapeLayout parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions)
    public static CTShapeLayout parse(final Node node)
    public static CTShapeLayout parse(final Node node, final XmlOptions xmlOptions)
    public static CTShapeLayout parse(final XMLInputStream xmlInputStream)
