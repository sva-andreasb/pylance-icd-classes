...
def parse():
    ...
    public static StyleSheetsType parse(final URL url)
    public static StyleSheetsType parse(final URL url, final XmlOptions xmlOptions)
    public static StyleSheetsType parse(final InputStream inputStream)
    public static StyleSheetsType parse(final InputStream inputStream, final XmlOptions xmlOptions)
    public static StyleSheetsType parse(final Reader reader)
    public static StyleSheetsType parse(final Reader reader, final XmlOptions xmlOptions)
    public static StyleSheetsType parse(final XMLStreamReader xmlStreamReader)
    public static StyleSheetsType parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions)
    public static StyleSheetsType parse(final Node node)
    public static StyleSheetsType parse(final Node node, final XmlOptions xmlOptions)
    public static StyleSheetsType parse(final XMLInputStream xmlInputStream)
