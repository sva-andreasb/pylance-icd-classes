...
public static PageContentsDocument parse(final URL url)
public static PageContentsDocument parse(final URL url, final XmlOptions xmlOptions)
public static PageContentsDocument parse(final InputStream inputStream)
public static PageContentsDocument parse(final InputStream inputStream, final XmlOptions xmlOptions)
public static PageContentsDocument parse(final Reader reader)
public static PageContentsDocument parse(final Reader reader, final XmlOptions xmlOptions)
public static PageContentsDocument parse(final XMLStreamReader xmlStreamReader)
public static PageContentsDocument parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions)
public static PageContentsDocument parse(final Node node)
public static PageContentsDocument parse(final Node node, final XmlOptions xmlOptions)
public static PageContentsDocument parse(final XMLInputStream xmlInputStream)
