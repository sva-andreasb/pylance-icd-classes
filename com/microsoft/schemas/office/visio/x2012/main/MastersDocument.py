...
public static MastersDocument parse(final URL url)
public static MastersDocument parse(final URL url, final XmlOptions xmlOptions)
public static MastersDocument parse(final InputStream inputStream)
public static MastersDocument parse(final InputStream inputStream, final XmlOptions xmlOptions)
public static MastersDocument parse(final Reader reader)
public static MastersDocument parse(final Reader reader, final XmlOptions xmlOptions)
public static MastersDocument parse(final XMLStreamReader xmlStreamReader)
public static MastersDocument parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions)
public static MastersDocument parse(final Node node)
public static MastersDocument parse(final Node node, final XmlOptions xmlOptions)
public static MastersDocument parse(final XMLInputStream xmlInputStream)
