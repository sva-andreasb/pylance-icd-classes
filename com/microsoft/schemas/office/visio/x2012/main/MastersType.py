...
def parse():
    ...
    public static MastersType parse(final URL url)
    public static MastersType parse(final URL url, final XmlOptions xmlOptions)
    public static MastersType parse(final InputStream inputStream)
    public static MastersType parse(final InputStream inputStream, final XmlOptions xmlOptions)
    public static MastersType parse(final Reader reader)
    public static MastersType parse(final Reader reader, final XmlOptions xmlOptions)
    public static MastersType parse(final XMLStreamReader xmlStreamReader)
    public static MastersType parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions)
    public static MastersType parse(final Node node)
    public static MastersType parse(final Node node, final XmlOptions xmlOptions)
    public static MastersType parse(final XMLInputStream xmlInputStream)
