def ():
    '''returns AnnotationIntrospectorPair\n\n
    (final AnnotationIntrospector p, final AnnotationIntrospector s)\n
    '''
def version():
    '''returns Version\n\n
    version()\n
...
def findImplicitPropertyName():
    '''returns String\n\n
    findImplicitPropertyName(final AnnotatedMember ann)\n
    '''
...
def findEnumValues():
    '''returns String[]\n\n
    findEnumValues(final Class<?> enumType, final Enum<?>[] enumValues, String[] names)\n
    '''
def findEnumValue():
    '''returns String\n\n
