def ():
    '''returns UTF8StreamJsonParser\n\n
    (final IOContext ctxt, final int features, final InputStream in, final ObjectCodec codec, final ByteQuadsCanonicalizer sym, final byte[] inputBuffer, final int start, final int end, final boolean bufferRecyclable)\n
    '''
def getCodec():
    '''returns ObjectCodec\n\n
    getCodec()\n
