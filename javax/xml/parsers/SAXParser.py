...
def parse():
    ...
    public void parse(final String s, final HandlerBase handlerBase)
    public void parse(final String s, final DefaultHandler defaultHandler)
    public void parse(final File file, final HandlerBase handlerBase)
    public void parse(final File file, final DefaultHandler defaultHandler)
