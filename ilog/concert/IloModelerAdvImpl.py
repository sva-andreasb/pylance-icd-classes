...
def numMap():
    '''returns IloNumMap\n\n
    numMap(final IloDiscreteDataCollection indexer)\n
    numMap(final IloDiscreteDataCollection[] vars)\n
    '''
def intMap():
    '''returns IloIntMap\n\n
    intMap(final IloDiscreteDataCollection indexer)\n
    intMap(final IloDiscreteDataCollection[] vars)\n
    '''
def intVarMap():
    '''returns IloIntVarMap\n\n
    intVarMap(final IloDiscreteDataCollection indexer)\n
    intVarMap(final IloDiscreteDataCollection[] vars)\n
    '''
def numVarMap():
    '''returns IloNumVarMap\n\n
    numVarMap(final IloDiscreteDataCollection indexer)\n
    numVarMap(final IloDiscreteDataCollection[] vars)\n
    '''
def symbolSet():
