def FractionalCutCallbackWrapper():
'''public FractionalCutCallbackWrapper(final long cPtr, final boolean cMemoryOwn)
public FractionalCutCallbackWrapper(final IloEnv env)
'''
pass
def getCPtr():
'''public static long getCPtr(final FractionalCutCallbackWrapper obj)
'''
pass
def delete():
'''public void delete()
