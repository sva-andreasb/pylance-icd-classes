def UserCutCallbackWrapper():
    '''public UserCutCallbackWrapper(final long cPtr, final boolean cMemoryOwn)
    public UserCutCallbackWrapper(final IloEnv env)
    '''
def getCPtr():
    '''public static long getCPtr(final UserCutCallbackWrapper obj)
    '''
def delete():
    '''public void delete()
    '''
...
def addLocal():
    ...
    '''
def isAfterCutLoop():
    '''public boolean isAfterCutLoop()
    '''
def abortCutLoop():
    '''public void abortCutLoop()
    '''
