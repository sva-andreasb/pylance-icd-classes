def IncumbentCallbackWrapper():
    '''public IncumbentCallbackWrapper(final long cPtr, final boolean cMemoryOwn)
    public IncumbentCallbackWrapper(final IloEnv env)
    '''
def getCPtr():
    '''public static long getCPtr(final IncumbentCallbackWrapper obj)
    '''
def delete():
    '''public void delete()
    '''
