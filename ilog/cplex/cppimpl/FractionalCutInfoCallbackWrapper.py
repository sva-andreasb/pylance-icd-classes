def FractionalCutInfoCallbackWrapper():
'''public FractionalCutInfoCallbackWrapper(final long cPtr, final boolean cMemoryOwn)
public FractionalCutInfoCallbackWrapper(final IloEnv env)
'''
pass
def getCPtr():
'''public static long getCPtr(final FractionalCutInfoCallbackWrapper obj)
'''
pass
def delete():
'''public void delete()
