def HeuristicCallbackWrapper():
    '''public HeuristicCallbackWrapper(final long cPtr, final boolean cMemoryOwn)
    public HeuristicCallbackWrapper(final IloEnv env)
    '''
def getCPtr():
    '''public static long getCPtr(final HeuristicCallbackWrapper obj)
    '''
def delete():
    '''public void delete()
    '''
...
def setBounds():
    ...
    '''
def solve():
    '''public boolean solve(final IloCplex.Algorithm alg)
