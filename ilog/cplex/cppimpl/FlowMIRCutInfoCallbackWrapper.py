def FlowMIRCutInfoCallbackWrapper():
'''public FlowMIRCutInfoCallbackWrapper(final long cPtr, final boolean cMemoryOwn)
public FlowMIRCutInfoCallbackWrapper(final IloEnv env)
'''
pass
def getCPtr():
'''public static long getCPtr(final FlowMIRCutInfoCallbackWrapper obj)
'''
pass
def delete():
'''public void delete()
