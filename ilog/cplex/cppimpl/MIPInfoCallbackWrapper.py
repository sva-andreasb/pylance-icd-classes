def MIPInfoCallbackWrapper():
    '''public MIPInfoCallbackWrapper(final long cPtr, final boolean cMemoryOwn)
    public MIPInfoCallbackWrapper(final IloEnv env)
    '''
def getCPtr():
    '''public static long getCPtr(final MIPInfoCallbackWrapper obj)
    '''
def delete():
    '''public void delete()
    '''
