def SolveCallbackWrapper():
'''public SolveCallbackWrapper(final long cPtr, final boolean cMemoryOwn)
public SolveCallbackWrapper(final IloEnv env)
'''
pass
def getCPtr():
'''public static long getCPtr(final SolveCallbackWrapper obj)
'''
pass
def delete():
'''public void delete()
