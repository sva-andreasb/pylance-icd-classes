def ProbingInfoCallbackWrapper():
'''public ProbingInfoCallbackWrapper(final long cPtr, final boolean cMemoryOwn)
public ProbingInfoCallbackWrapper(final IloEnv env)
'''
pass
def getCPtr():
'''public static long getCPtr(final ProbingInfoCallbackWrapper obj)
'''
pass
def delete():
'''public void delete()
