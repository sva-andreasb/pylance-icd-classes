def MIPCallbackWrapper():
'''public MIPCallbackWrapper(final long cPtr, final boolean cMemoryOwn)
public MIPCallbackWrapper(final IloEnv env)
'''
pass
def getCPtr():
'''public static long getCPtr(final MIPCallbackWrapper obj)
'''
pass
def delete():
'''public void delete()
