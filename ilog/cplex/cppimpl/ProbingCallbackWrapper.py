def ProbingCallbackWrapper():
    '''    public ProbingCallbackWrapper(final long cPtr, final boolean cMemoryOwn)
    public ProbingCallbackWrapper(final IloEnv env)
    '''
def getCPtr():
    '''    public static long getCPtr(final ProbingCallbackWrapper obj)
    '''
def delete():
    '''    public void delete()
    '''
