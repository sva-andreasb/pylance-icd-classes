def ():
    '''returns IloNumCollectionMapBase\n\n
...
def set():
    '''returns None\n\n
    set(final int idx, final IloNumCollection value)\n
    set(final double idx, final IloNumCollection value)\n
    set(final String idx, final IloNumCollection value)\n
    set(final IloTuple idx, final IloNumCollection value)\n
    set(final IloSymbol idx, final IloNumCollection value)\n
    '''
def setAt():
    '''returns None\n\n
    setAt(final IloMapIndexArray indices, final IloNumCollection value)\n
