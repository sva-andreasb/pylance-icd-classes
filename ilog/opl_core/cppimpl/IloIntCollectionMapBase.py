def ():
    '''returns IloIntCollectionMapBase\n\n
...
def set():
    '''returns None\n\n
    set(final int idx, final IloIntCollection value)\n
    set(final double idx, final IloIntCollection value)\n
    set(final String idx, final IloIntCollection value)\n
    set(final IloTuple idx, final IloIntCollection value)\n
    set(final IloSymbol idx, final IloIntCollection value)\n
    '''
def setAt():
    '''returns None\n\n
    setAt(final IloMapIndexArray indices, final IloIntCollection value)\n
