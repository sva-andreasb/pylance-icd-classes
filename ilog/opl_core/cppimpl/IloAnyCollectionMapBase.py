def ():
    '''returns IloAnyCollectionMapBase\n\n
...
def set():
    '''returns None\n\n
    set(final int idx, final IloAnyCollection value)\n
    set(final double idx, final IloAnyCollection value)\n
    set(final String idx, final IloAnyCollection value)\n
    set(final IloTuple idx, final IloAnyCollection value)\n
    set(final IloSymbol idx, final IloAnyCollection value)\n
    '''
def setAt():
    '''returns None\n\n
    setAt(final IloMapIndexArray indices, final IloAnyCollection value)\n
