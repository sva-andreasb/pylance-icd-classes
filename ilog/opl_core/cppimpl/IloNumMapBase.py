...
def set():
    '''returns None\n\n
    set(final int idx, final double value)\n
    set(final double idx, final double value)\n
    set(final String idx, final double value)\n
    set(final IloTuple idx, final double value)\n
    set(final IloSymbol idx, final double value)\n
    '''
def setAt():
    '''returns None\n\n
    setAt(final IloMapIndexArray indices, final double value)\n
