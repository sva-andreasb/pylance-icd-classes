...
def set():
    '''returns None\n\n
    set(final int idx, final IloExtractable value)\n
    set(final double idx, final IloExtractable value)\n
    set(final String idx, final IloExtractable value)\n
    set(final IloTuple idx, final IloExtractable value)\n
    set(final IloSymbol idx, final IloExtractable value)\n
    '''
def setAt():
    '''returns None\n\n
    setAt(final IloMapIndexArray indices, final IloExtractable value)\n
