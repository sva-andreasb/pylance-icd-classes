...
def set():
    '''returns None\n\n
    set(final int idx, final IloSymbol value)\n
    set(final double idx, final IloSymbol value)\n
    set(final String idx, final IloSymbol value)\n
    set(final IloTuple idx, final IloSymbol value)\n
    set(final IloSymbol idx, final IloSymbol value)\n
    '''
def setAt():
    '''returns None\n\n
    setAt(final IloMapIndexArray indices, final IloSymbol value)\n
