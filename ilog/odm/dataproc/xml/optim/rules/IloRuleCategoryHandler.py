...
def ():
    '''returns IloRuleCategoryHandler\n\n
    (final IloDefaultRecursiveHandler previous, final Attributes attrs, final IloNameSpaceProfileManager ns)\n
    '''
def startElement():
    '''returns None\n\n
