...
def ():
    '''returns IloConfigSetOptimModelHandler\n\n
...
def endElement():
    ...
    '''
def getOplFileCollection():
    '''returns IloOplFileCollection\n\n
    getOplFileCollection()\n
    '''
def getBusinessViewLocation():
    '''returns IloURLLocation\n\n
    getBusinessViewLocation()\n
    '''
