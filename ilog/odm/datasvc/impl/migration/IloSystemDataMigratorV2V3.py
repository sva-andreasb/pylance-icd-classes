...
def ():
    '''returns IloSystemDataMigratorV2V3\n\n
...
def migrateScenarioCatalog():
    ...
    '''
def migrateWorkspaces():
    '''returns None\n\n
    migrateWorkspaces(final IloRepositoryManager repository_manager, final Map<String, IloSchemaCatalog> source_catalog_map, final Map<String, IloSchemaCatalog> destination_catalog_map)\n
    '''
