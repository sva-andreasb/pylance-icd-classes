...
def ():
    '''returns IloSystemDataMigratorV0V1\n\n
...
def migrateScenarioAndDataTables():
    ...
    '''
def migrateWorkspaceTables():
    '''returns None\n\n
    migrateWorkspaceTables(final IloRepositoryManager repository_manager, final Map<String, IloSchemaCatalog> source_catalog_map, final Map<String, IloSchemaCatalog> destination_catalog_map)\n
    '''
