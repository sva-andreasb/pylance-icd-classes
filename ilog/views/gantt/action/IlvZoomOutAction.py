def IlvZoomOutAction():
    '''    public IlvZoomOutAction(final IlvTimeScrollable ilvTimeScrollable, final String s, final KeyStroke keyStroke, final String s2, final String s3)
    public IlvZoomOutAction(final IlvTimeScrollable b, final String s, final Icon icon, final KeyStroke keyStroke, final String s2, final String s3)
    '''
