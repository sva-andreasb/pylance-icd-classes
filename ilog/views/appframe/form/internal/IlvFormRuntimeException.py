def IlvFormRuntimeException():
    ...
    public IlvFormRuntimeException(final IlvForm ilvForm, final String s, final String s2, final String s3)
    public IlvFormRuntimeException(final IlvForm ilvForm, final String s, final String s2, final String s3, final Throwable t)
