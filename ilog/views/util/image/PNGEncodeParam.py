...
def setInterlacing():
    '''returns None\n\n
    setInterlacing(final boolean a)\n
    '''
def getInterlacing():
    '''returns boolean\n\n
    getInterlacing()\n
...
def setChromaticity():
    '''returns None\n\n
    setChromaticity(final float[] array)\n
    setChromaticity(final float n, final float n2, final float n3, final float n4, final float n5, final float n6, final float n7, final float n8)\n
    '''
def getChromaticity():
    '''returns float[]\n\n
    getChromaticity()\n
...
def setPaletteHistogram():
    '''returns None\n\n
    setPaletteHistogram(final int[] array)\n
    '''
...
def setICCProfileData():
    '''returns None\n\n
    setICCProfileData(final byte[] array)\n
    '''
...
def setPhysicalDimension():
    '''returns None\n\n
    setPhysicalDimension(final int[] array)\n
    setPhysicalDimension(final int n, final int n2, final int n3)\n
    '''
...
def setSuggestedPalette():
    '''returns None\n\n
    setSuggestedPalette(final PNGSuggestedPaletteEntry[] array)\n
    '''
...
def setSignificantBits():
    '''returns None\n\n
    setSignificantBits(final int[] array)\n
    '''
...
def setModificationTime():
    '''returns None\n\n
    setModificationTime(final Date t)\n
    '''
...
def setCompressedText():
    '''returns None\n\n
    setCompressedText(final String[] w)\n
    '''
...
def filterRow():
    '''returns int\n\n
    filterRow(final byte[] array, final byte[] array2, final byte[][] array3, final int n, final int n2)\n
    '''
def setBitDepth():
    '''returns None\n\n
...
def setTransparentRGB():
    '''returns None\n\n
    setTransparentRGB(final int[] array)\n
    '''
...
def setTransparentGray():
    '''returns None\n\n
    setTransparentGray(final int n)\n
    '''
...
def setBackgroundPaletteIndex():
    '''returns None\n\n
    setBackgroundPaletteIndex(final int d)\n
    '''
...
def setPaletteTransparency():
    '''returns None\n\n
    setPaletteTransparency(final byte[] array)\n
    '''
